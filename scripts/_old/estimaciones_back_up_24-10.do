...
loc var_control "pbg_pc_puig expo_total_a_pbg tasa_mort_inf"

loc estim " fe re"

loc crec_3 "crec_prom_3 crec_rapetti_3"

loc crec_4 " crec_prom_4 crec_rapetti_4"


loc aux "replace"

loc gini_3 "gini_inicial_periodo_3 gini_inicial_per_lag_3 gini_prom_3 gini_prom_lag_3 ln_gini_inicial_periodo_3 ln_gini_inicial_per_lag_3 ln_gini_prom_3 ln_gini_prom_lag_3"

loc gini_4 "gini_inicial_periodo_4 gini_inicial_per_lag_4 gini_prom_4 gini_prom_lag_4 ln_gini_inicial_periodo_4 ln_gini_inicial_per_lag_4 ln_gini_prom_4 ln_gini_prom_lag_4"
	...
	foreach i in `estim' {
		...
		foreach g in `gini_`x'' {
			...
			foreach c in `crec_`x'' {
				...
				outreg2 using e_`c'_`g'.xls, `aux' ctitle (`i'_sc) 
				
				xtreg `c' `g' `var_control' if reg_`x'==1, `i' robust
				outreg2 using e_`c'_`g'.xls, append ctitle (`i'_cc) 
			
				xtreg `c' `g' `var_control' if reg_`x'==1, `i' vce (cluster nreg)
				outreg2 using e_`c'_`g'.xls, append ctitle (`i'_cc_clu) 		
...
foreach gn of loc `gini_3' {
	...
	xtabond2 crec_prom_3 l.crec_prom_3 l.pbg_pc_puig l.expo_total_a_pbg i.time, gmm(l.crec_prom_3 `gn') iv(l.pbg_pc_puig l.expo_total_a_pbg i.time) robust two small orthogonal nodiffsargan
...
xtreg crec_prom_4 ln_gini_inicial_per_lag_4 pbg_pc_puig expo_total_a_pbg tasa_mort_inf, fe
...
xtabond2 crec_rapetti_3 l.crec_rapetti_3 l.pbg_pc_puig ln_gini_inicial_per_lag_3 i.año, gmm(l.crec_rapetti_3 ln_gini_inicial_per_lag_3 ) robust two small orthogonal nodiffsargan

*ESTO DA. HAY QUE ENTENDER PORQUE ENTRA SIN EL SMALL
xtabond2 crec_rapetti_3 l.crec_rapetti_3 l.pbg_pc_puig ln_gini_inicial_per_lag_3 i.año, gmm(l.crec_rapetti_3 ln_gini_inicial_per_lag_3) robust two  orthogonal nodiffsargan

xtabond2 crec_rapetti_3 l.crec_rapetti_3 l.pbg_pc_puig gini_inicial_per_lag_3 i.año, gmm(l.crec_rapetti_3 gini_inicial_per_lag_3) robust two  orthogonal nodiffsargan

xtabond2 crec_rapetti_3 l.crec_rapetti_3 l.pbg_pc_puig gini_inicial_per_lag_3 i.año, gmm(l.crec_rapetti_3 gini_inicial_per_lag_3) iv(i.año l.pbg_pc_puig) robust two orthogonal nodiffsargan
...
xi:xtreg ln_gini_inicial_per_lag_3 pbg_pc_puig tasa_mort_inf i.año, fe robust 
predict ln_gini_lag_hat 
xi:xtreg crec_rapetti_3 ln_gini_lag_hat pbg_pc_puig tasa_mort_inf i.año, fe robust 
...
xi:xtreg crec_rapetti_3 gini_inicial_per_lag_3 pbg_pc_puig tasa_mort_inf i.año, fe robust
