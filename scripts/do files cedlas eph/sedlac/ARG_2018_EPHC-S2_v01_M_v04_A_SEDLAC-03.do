...
local va       	"04"     	// Alternative version
...
replace agua = 0		if  iv6==3 | v7==3 | iv7==4 
...
/*	 1 = Adobe, zarzo, lodo                      
  ...
  V2: Cuál es el material que predomina en los muros exteriores de la vivienda?
		...
		6. Materiales precarios o de desecho (cartón, latas, sacos, plásticos)	*/
gen     pared = .
replace pared = 1	if  v2==5
*replace pared = 2	if  v2==
*replace pared = 3	if  v2==
*replace pared = 4	if  v2==
replace pared = 5	if  v2==1 | v2==2
*replace pared = 6	if  v2==
*replace pared = 7	if  v2==
replace pared = 99	if  v2==3 | v2==4 | v2==6
notes   pared: other includes "tabique forrado (madera, acero, lata u otro)", "tabique sin forro interior (madera u otro)" and "materiales precarios o de desecho (carton, latas, sacos, plastico)"
...
*************************************************************************************************************************************************)*/
* ARG 2018: Personas de 10 y más años de edad
...
notes   sector1d: there are 656 missings observations with ocupado==1 in the variable sector1d
...
notes   sector: there are 656 missings observations with ocupado==1 in the variable sector
...
gen     lp_extrema = 2753.08		if  trimestre==3 & gba==1   
replace lp_extrema = 2466.96		if  trimestre==3 & pampa==1 
replace lp_extrema = 2461.61		if  trimestre==3 & cuyo==1	
replace lp_extrema = 2403.75		if  trimestre==3 & noa==1	
replace lp_extrema = 2730.59		if  trimestre==3 & pata==1  
replace lp_extrema = 2836.20		if  trimestre==3 & nea==1   
							            
replace	lp_extrema = 3242.27		if  trimestre==4 & gba==1   
replace lp_extrema = 2899.13		if  trimestre==4 & pampa==1 
replace lp_extrema = 2886.34		if  trimestre==4 & cuyo==1	
replace lp_extrema = 2812.15		if  trimestre==4 & noa==1	
replace lp_extrema = 3212.49		if  trimestre==4 & pata==1  
replace lp_extrema = 3341.05		if  trimestre==4 & nea==1   

* Linea de pobreza oficial moderada ("linea de pobreza")
gen     lp_moderada = 6856.65		if  trimestre==3 & gba==1   
replace lp_moderada = 6537.66		if  trimestre==3 & pampa==1 
replace lp_moderada = 5735.76		if  trimestre==3 & cuyo==1
replace lp_moderada = 5552.90		if  trimestre==3 & noa==1
replace lp_moderada = 6799.42		if  trimestre==3 & pata==1  
replace lp_moderada = 8017.66		if  trimestre==3 & nea==1   
							            
replace	lp_moderada = 8084.25		if  trimestre==4 & gba==1   
replace lp_moderada = 7692.51		if  trimestre==4 & pampa==1 
replace lp_moderada = 6704.93		if  trimestre==4 & cuyo==1
replace lp_moderada = 6505.58		if  trimestre==4 & noa==1
replace lp_moderada = 8009.99		if  trimestre==4 & pata==1  
replace lp_moderada = 9444.39		if  trimestre==4 & nea==1   
...
* IPC del mes base
gen ipc = 880.394548865844	/*  MES BASE: promedio Julio-Diciembre	*/

gen cpiperiod = "2018m07-2018m12"

* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.928		if  trimestre==3
replace ipc_rel = 1.072		if  trimestre==4
