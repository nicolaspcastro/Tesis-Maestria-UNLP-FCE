...
*************************************************************************************************************************************************)*/
* ARG 2003: Personas de 10 y más años de edad
...
* Armonización de ocupaciones a ISCO-2008
/* OCUPACION DEL TRABAJADOR

	Variable SEDLAC: tarea
	  Variable EPHC: PP04D_COD
	   Codificación: Clasificador Nacional de Ocupaciones - CNO-2001

Se convierten ocupaciones del CNO-01 a ISCO-08 con el crosswalk oficial del INDEC.
Este presenta 4 casos especiales donde el primer dígito de ISCO es 2, 3, 7 u 8 y
el segundo puede determinarse aproximadamente en combinación con información de la
...
clasificación CAES-MERCOSUR 1.0 para ramas de actividad. Esta clasificacion esta
...
** Casos especiales que requieren información de la rama de actividad
gen     ciuo08 = "."
...
gen     oficio1 = .
replace oficio1 =  1    if  ofi==149311 | ofi==149312 | ofi==149322 | ofi==149331 | ofi==149332 
...
replace oficio1 = 32    if  ofi==40112 | ofi==40132 | ofi==40202 | ofi==40312 | ofi==40322 | ofi==40323 | ofi==40332 | ofi==40333 
...
replace oficio1 = 41	if  ofi==10113 | ofi==10123 | ofi==10132 | ofi==10203 | ofi==10313 | ofi==10323 | ofi==10333 | ofi==11313 | ofi==11333 | ofi==20314 | ofi==81333 | ofi==10339 
...
replace v18_m_hd = .	if  v18_m_hd>=1000
...
gen	lp_extrema =     .	
replace lp_extrema =  112.22		if  trimestre==3     	
replace lp_extrema =  115.43		if  trimestre==4 		
...
gen	lp_moderada =     .
replace lp_moderada =  300.55		if  trimestre==3    
replace lp_moderada =  305.85		if  trimestre==4    
...
* IPC del mes base
gen ipc = 37.3602606455485		/*  MES BASE: promedio Junio-Noviembre	*/

gen cpiperiod = "2003m07-2003m12"
   
* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.997		if  trimestre==3
replace ipc_rel = 1.003		if  trimestre==4
