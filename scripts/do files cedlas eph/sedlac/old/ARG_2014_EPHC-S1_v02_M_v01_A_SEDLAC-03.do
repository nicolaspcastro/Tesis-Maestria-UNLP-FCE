...
replace aux_asistencia = 1	if  v5_m>=350 & v5_m<=370
replace aux_asistencia = 1	if  v5_m>=720 & v5_m<=750
replace aux_asistencia = 1	if v5_m>=1100 & v5_m<=1110
replace aux_asistencia = 1	if v5_m>=1400 & v5_m<=1500
replace aux_asistencia = 1	if v5_m>=1800 & v5_m<=1900
...
notes iasalp_m:  relab = 2: 765 zero incomes - 0 missing observations
...
notes ictapp_m:  relab = 3: 273 zero incomes - 0 missing observations
...
notes ipatrp_m:  relab = 1: 40 zero incomes - 0 missing observations
...
*    Estimaciones a partir de 2014 porque el gobierno no las reporta

gen	lp_extrema = 274.63		if  trimestre==1		/*( modificar cada semestre	)*/                  
replace lp_extrema = 291.48		if  trimestre==2                
...
gen	lp_moderada = 624.64		if  trimestre==1		/*( modificar cada semestre	)*/                 
replace lp_moderada = 662.97		if  trimestre==2                
...
* IPC del mes base
gen ipc = 245.809488932291657	/*  MES BASE: promedio Enero-Junio	*/
