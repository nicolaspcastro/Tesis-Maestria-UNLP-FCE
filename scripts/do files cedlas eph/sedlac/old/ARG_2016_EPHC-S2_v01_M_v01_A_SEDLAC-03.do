...
replace      relacion_est = 11	if  (nro_hogar>=51 & nro_hogar<=91) | componen==51
label define relacion_est 1 "Jefe/a" 2 "Cónyuge/Pareja" 3 "Hijo/Hijastro" 4 "Yerno/Nuera" 5 "Nieto" 6 "Padre/Madre" 7 "Suegro" 8 "Hermano" 9 "Otro Pariente" 10 "No Pariente" 11 "Empleado Doméstico y Familiares"
label values relacion_est relacion_est

* Miembros de hogares secundarios:	hogarsec
gen     hogarsec = 0
replace hogarsec = 1		if  relacion_est==11
...
gen	lp_extrema = 1684.25			if  trimestre==3 & ano==2016 & region_est1==1
replace lp_extrema = 1508.81			if  trimestre==3 & ano==2016 & region_est1==3
replace lp_extrema = 1512.93			if  trimestre==3 & ano==2016 & region_est1==6
replace lp_extrema = 1472.08			if  trimestre==3 & ano==2016 & region_est1==4
replace lp_extrema = 1676.16			if  trimestre==3 & ano==2016 & region_est1==2 
replace lp_extrema = 1735.14			if  trimestre==3 & ano==2016 & region_est1==5		

replace	lp_extrema = 1756.20			if  trimestre==4 & ano==2016 & region_est1==1
replace lp_extrema = 1570.30			if  trimestre==4 & ano==2016 & region_est1==3
replace lp_extrema = 1568.09			if  trimestre==4 & ano==2016 & region_est1==6	
replace lp_extrema = 1525.45			if  trimestre==4 & ano==2016 & region_est1==4	
replace lp_extrema = 1746.40			if  trimestre==4 & ano==2016 & region_est1==2 
replace lp_extrema = 1813.35			if  trimestre==4 & ano==2016 & region_est1==5

* Linea de pobreza oficial moderada("linea de pobreza")
gen	lp_moderada = 4055.15			if  trimestre==3 & ano==2016 & region_est1==1
replace lp_moderada = 3872.37			if  trimestre==3 & ano==2016 & region_est1==3
replace lp_moderada = 3413.95			if  trimestre==3 & ano==2016 & region_est1==6
replace lp_moderada = 3292.33			if  trimestre==3 & ano==2016 & region_est1==4
replace lp_moderada = 4033.72			if  trimestre==3 & ano==2016 & region_est1==2       
replace lp_moderada = 4742.32			if  trimestre==3 & ano==2016 & region_est1==5	
			
replace	lp_moderada = 4232.45			if  trimestre==4 & ano==2016 & region_est1==1
replace lp_moderada = 4030.41			if  trimestre==4 & ano==2016 & region_est1==3
replace lp_moderada = 3538.65			if  trimestre==4 & ano==2016 & region_est1==6 
replace lp_moderada = 3411.90			if  trimestre==4 & ano==2016 & region_est1==4
replace lp_moderada = 4208.81			if  trimestre==4 & ano==2016 & region_est1==2
replace lp_moderada = 4962.51			if  trimestre==4 & ano==2016 & region_est1==5
...
* IPC del mes base
gen ipc = 505.615127563476563	/*  MES BASE: promedio Julio-Diciembre	*/
