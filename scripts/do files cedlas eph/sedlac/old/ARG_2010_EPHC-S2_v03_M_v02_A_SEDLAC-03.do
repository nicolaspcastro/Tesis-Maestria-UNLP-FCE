...
replace aux_asistencia = 1	if  v5_m>=140 & v5_m<=150
replace aux_asistencia = 1	if  v5_m>=170 & v5_m<=180
replace aux_asistencia = 1	if  v5_m>=280 & v5_m<=300
replace aux_asistencia = 1	if  v5_m>=350 & v5_m<=360
replace aux_asistencia = 1	if  v5_m>=420 & v5_m<=440	
replace aux_asistencia = 1	if  v5_m>=520 & v5_m<=540	
replace aux_asistencia = 1	if  v5_m>=560 & v5_m<=600		
