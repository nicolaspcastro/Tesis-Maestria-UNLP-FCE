...
*exit
do "C:\Cedlas\do\fgt.do"
capture drop ppp* 
capture drop ipc_*
merge m:1 pais ano encuesta using "D:\Dropbox\datalib\sedlac\ipc_sedlac_wb.dta", keepusing(ipc_sedlac ipc11_sedlac ppp11)

gen lp_19usd = (1.90*365/12)*ppp11*(ipc_sedlac/ipc11_sedlac)
gen lp_32usd = (3.20*365/12)*ppp11*(ipc_sedlac/ipc11_sedlac)
gen lp_55usd = (5.50*365/12)*ppp11*(ipc_sedlac/ipc11_sedlac)


fgt ipcf [w=pondera]  if  cohh==1, 			z(lp_19usd) a(0) 
fgt ipcf [w=pondera]  if  cohh==1, 			z(lp_32usd) a(0) 
fgt ipcf [w=pondera]  if  cohh==1,            z(lp_55usd) a(0) 
