...
notes iasalp_m:  relab = 2: 2528 zero incomes - 0 missing observations
...
notes ictapp_m:  relab = 3: 331 zero incomes - 0 missing observations
...
notes ipatrp_m:  relab = 1: 31 zero incomes - 0 missing observations
...
gen	lp_extrema = 117.81		if  trimestre==3	/*( modificar cada semestre	)*/                  
replace lp_extrema = 123.34		if  trimestre==4                
...
gen	lp_moderada = 256.79		if  trimestre==3	/*( modificar cada semestre	)*/                 
replace lp_moderada = 266.40		if  trimestre==4                
...
* IPC del mes base
gen ipc = 43.6798623402913435			/*  MES BASE: promedio Junio-Noviembre	*/
