...
notes iasalp_m:  relab = 2: 1000 zero incomes - 0 missing observations
...
notes ictapp_m:  relab = 3: 262 zero incomes - 0 missing observations
...
gen	lp_extrema = 165.70		if  trimestre==1		/*( modificar cada semestre	)*/                  
replace lp_extrema = 172.67		if  trimestre==2                
...
gen	lp_moderada = 364.07		if  trimestre==1		/*( modificar cada semestre	)*/                 
replace lp_moderada = 374.29		if  trimestre==2                
...
* IPC del mes base
gen ipc = 94.8218981424967495		/*  MES BASE: promedio Diciembre-Mayo	*/
