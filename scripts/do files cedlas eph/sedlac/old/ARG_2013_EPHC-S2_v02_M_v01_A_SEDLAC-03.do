...
replace relacion = 6		if  ch03==10 | (componen>=51 & componen<=81)

* Estandarizada
gen          relacion_est = ch03
replace      relacion_est = 11	if  componen==51 | componen==61
replace      relacion_est = 12	if  componen==71 | componen==72 | componen==82
...
notes iasalp_m:  relab = 2: 790 zero incomes - 0 missing observations
...
notes ictapp_m:  relab = 3: 165 zero incomes - 0 missing observations
...
notes ipatrp_m:  relab = 1: 30 zero incomes - 0 missing observations
...
gen	lp_extrema = 241.73		if  trimestre==3		/*( modificar cada semestre	)*/                  
replace lp_extrema = 249.86		if  trimestre==4                
...
gen	lp_moderada = 552.96		if  trimestre==3		/*( modificar cada semestre	)*/                 
replace lp_moderada = 568.31		if  trimestre==4                
...
* IPC del mes base
gen ipc = 203.222335815429688	/*  MES BASE: promedio Julio-Diciembre	*/
