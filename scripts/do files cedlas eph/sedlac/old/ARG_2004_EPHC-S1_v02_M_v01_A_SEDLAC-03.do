...
notes iasalp_m:  relab = 2: 3605 zero incomes - 0 missing observations
...
notes ictapp_m:  relab = 3: 462 zero incomes - 0 missing observations
...
notes ipatrp_m:  relab = 1: 41 zero incomes - 0 missing observations
...
gen	lp_extrema = 106.00		if  trimestre==1		/*( modificar cada semestre	)*/                  
replace lp_extrema = 106.69		if  trimestre==2                
...
gen	lp_moderada = 232.14		if  trimestre==1		/*( modificar cada semestre	)*/                 
replace lp_moderada = 233.65		if  trimestre==2                
...
* IPC del mes base
gen ipc = 38.2291997273763045			/*  MES BASE: promedio Diciembre-Mayo	*/
