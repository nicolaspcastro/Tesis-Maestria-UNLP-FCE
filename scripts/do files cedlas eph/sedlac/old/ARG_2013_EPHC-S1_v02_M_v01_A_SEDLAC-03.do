...
notes iasalp_m:  relab = 2: 752 zero incomes - 0 missing observations
...
notes ictapp_m:  relab = 3: 204 zero incomes - 0 missing observations
...
notes ipatrp_m:  relab = 1: 26 zero incomes - 0 missing observations
...
gen	lp_extrema = 233.74		if  trimestre==1		/*( modificar cada semestre	)*/                  
replace lp_extrema = 235.35		if  trimestre==2                
...
gen	lp_moderada = 531.23		if  trimestre==1		/*( modificar cada semestre	)*/                 
replace lp_moderada = 538.01		if  trimestre==2                
...
* IPC del mes base
gen ipc = 181.475710550944001			/*  MES BASE: promedio Diciembre-Mayo	*/
