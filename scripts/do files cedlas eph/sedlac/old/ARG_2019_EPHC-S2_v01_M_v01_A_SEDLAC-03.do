...
gen     djubila2 = djubila
replace djubila2 = 0    if (relab==1 | relab==3) & (aedu>=0  & aedu<=14)
replace djubila2 = 0    if  relab==4 
replace djubila2 = 1    if (relab==1 | relab==3) & (aedu>=15 & aedu<.)
...
gen    ing_pob_ext = itf/aef
gen    ing_pob_mod = itf/aef
...
gen     ipc_rel = 1.000
replace ipc_rel = 0.938		if  trimestre==1
replace ipc_rel = 1.062		if  trimestre==2
