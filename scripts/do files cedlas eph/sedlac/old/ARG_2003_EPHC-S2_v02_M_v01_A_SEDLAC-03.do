...
notes iasalp_m:  relab = 2: 3949 zero incomes - 0 missing observations
...
notes ictapp_m:  relab = 3: 467 zero incomes - 0 missing observations
...
gen	lp_extrema = 102.13		if  trimestre==3		/*( modificar cada semestre	)*/                  
replace lp_extrema = 105.04		if  trimestre==4                
...
gen	lp_moderada = 225.70		if  trimestre==3		/*( modificar cada semestre	)*/                 
replace lp_moderada = 229.68		if  trimestre==4                
...
* IPC del mes base
gen ipc = 37.3602606455485002		/*  MES BASE: promedio Junio-Noviembre	*/
