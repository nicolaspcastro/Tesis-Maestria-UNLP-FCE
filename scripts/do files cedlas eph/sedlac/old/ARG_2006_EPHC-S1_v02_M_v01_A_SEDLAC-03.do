...
notes iasalp_m:  relab = 2: 2207 zero incomes - 0 missing observations
...
notes ictapp_m:  relab = 3: 309 zero incomes - 0 missing observations
...
gen	lp_extrema = 127.48		if  trimestre==1		/*( modificar cada semestre	)*/                  
replace lp_extrema = 127.23		if  trimestre==2                
...
gen	lp_moderada = 275.35		if  trimestre==1		/*( modificar cada semestre	)*/                 
replace lp_moderada = 276.92		if  trimestre==2                
...
* IPC del mes base
gen ipc = 46.2471981048583984			/*  MES BASE: promedio Diciembre-Mayo	*/
