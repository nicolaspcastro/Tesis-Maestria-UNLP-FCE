...
gen	lp_extrema = 325.25		if  trimestre==1		/*( modificar cada semestre	)*/                  
replace lp_extrema = 336.24		if  trimestre==2                
...
gen	lp_moderada = 739.78		if  trimestre==1		/*( modificar cada semestre	)*/                 
replace lp_moderada = 764.79		if  trimestre==2                
...
* IPC del mes base
gen ipc = 318.179840087890625	/*  MES BASE: promedio Diciembre-Mayo	*/
