...
notes iasalp_m:  relab = 2: 810 zero incomes - 0 missing observations
...
notes ictapp_m:  relab = 3: 129 zero incomes - 0 missing observations
...
notes ipatrp_m:  relab = 1: 17 zero incomes - 0 missing observations
...
gen	lp_extrema = 142.35		if  trimestre==3		/*( modificar cada semestre	)*/                  
replace lp_extrema = 143.57		if  trimestre==4                
...
gen	lp_moderada = 305.09		if  trimestre==3		/*( modificar cada semestre	)*/                 
replace lp_moderada = 309.16		if  trimestre==4                
...
* IPC del mes base
gen ipc = 59.0265744527181013			/*  MES BASE: promedio Junio-Noviembre	*/
