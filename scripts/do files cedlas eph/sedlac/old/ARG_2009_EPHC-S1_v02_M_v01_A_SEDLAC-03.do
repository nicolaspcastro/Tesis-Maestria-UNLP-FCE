...
notes iasalp_m:  relab = 2: 933 zero incomes - 0 missing observations
...
notes ictapp_m:  relab = 3: 252 zero incomes - 0 missing observations
...
notes ipatrp_m:  relab = 1: 44 zero incomes - 0 missing observations
...
gen	lp_extrema = 143.32		if  trimestre==1		/*( modificar cada semestre	)*/                  
replace lp_extrema = 143.90		if  trimestre==2                
...
gen	lp_moderada = 321.04		if  trimestre==1		/*( modificar cada semestre	)*/                 
replace lp_moderada = 324.70		if  trimestre==2                
...
* IPC del mes base
gen ipc = 79.1870269775390625			/*  MES BASE: promedio Diciembre-Mayo	*/
