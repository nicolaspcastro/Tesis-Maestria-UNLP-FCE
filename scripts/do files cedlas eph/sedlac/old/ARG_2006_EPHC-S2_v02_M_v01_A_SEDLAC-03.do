...
notes iasalp_m:  relab = 2: 2518 zero incomes - 0 missing observations
...
notes ipatrp_m:  relab = 1: 57 zero incomes - 0 missing observations
...
gen	lp_extrema = 126.61		if  trimestre==3		/*( modificar cada semestre	)*/                  
replace lp_extrema = 130.84		if  trimestre==4                
...
gen	lp_moderada = 278.54		if  trimestre==3		/*( modificar cada semestre	)*/                 
replace lp_moderada = 285.64		if  trimestre==4                
