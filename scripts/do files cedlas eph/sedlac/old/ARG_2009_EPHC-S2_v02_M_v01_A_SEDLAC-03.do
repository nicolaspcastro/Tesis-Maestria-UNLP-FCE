...
notes iasalp_m:  relab = 2: 1013 zero incomes - 0 missing observations
...
notes ictapp_m:  relab = 3: 261 zero incomes - 0 missing observations
...
notes ipatrp_m:  relab = 1: 46 zero incomes - 0 missing observations
...
* VARIABLES ORIGINALES DE LA ENCUESTA
* TOT_P12: Monto de ingreso de OTRAS OCUPACIONES (no se puede identificar relación laboral en las mismas) 
...
gen	lp_extrema = 146.57		if  trimestre==3		/*( modificar cada semestre	)*/                  
replace lp_extrema = 152.70		if  trimestre==4                
...
gen	lp_moderada = 331.38		if  trimestre==3		/*( modificar cada semestre	)*/                 
replace lp_moderada = 342.94		if  trimestre==4                
...
* IPC del mes base
gen ipc = 84.4265022277832031			/*  MES BASE: promedio Junio-Noviembre	*/
