...
notes iasalp_m:  relab = 2: 777 zero incomes - 0 missing observations
...
notes ictapp_m:  relab = 3: 168 zero incomes - 0 missing observations
...
gen	lp_extrema = 210.24		if  trimestre==1		/*( modificar cada semestre	)*/                  
replace lp_extrema = 218.37		if  trimestre==2                
...
gen	lp_moderada = 466.10		if  trimestre==1		/*( modificar cada semestre	)*/                 
replace lp_moderada = 482.58		if  trimestre==2                
...
* IPC del mes base
gen ipc = 142.796844482421875			/*  MES BASE: promedio Diciembre-Mayo	*/
