...
notes iasalp_m:  relab = 2: 1305 zero incomes - 0 missing observations
...
notes ictapp_m:  relab = 3: 235 zero incomes - 0 missing observations
...
notes ipatrp_m:  relab = 1: 42 zero incomes - 0 missing observations
...
gen	lp_extrema = 142.66		if  trimestre==3		/*( modificar cada semestre	)*/                  
replace lp_extrema = 143.46		if  trimestre==4                
...
gen	lp_moderada = 314.00		if  trimestre==3		/*( modificar cada semestre	)*/                 
replace lp_moderada = 316.25		if  trimestre==4                
...
* IPC del mes base
gen ipc = 74.0787251790364536			/*  MES BASE: promedio Junio-Noviembre	*/
