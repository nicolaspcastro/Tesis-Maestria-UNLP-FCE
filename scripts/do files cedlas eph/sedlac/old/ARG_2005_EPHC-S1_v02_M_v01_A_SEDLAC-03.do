...
notes iasalp_m:  relab = 2: 2616 zero incomes - 0 missing observations
...
notes ictapp_m:  relab = 3: 346 zero incomes - 0 missing observations
...
gen	lp_extrema = 111.58		if  trimestre==1		/*( modificar cada semestre	)*/                  
replace lp_extrema = 114.24		if  trimestre==2                
...
gen	lp_moderada = 245.81		if  trimestre==1		/*( modificar cada semestre	)*/                 
replace lp_moderada = 250.56		if  trimestre==2                
...
* IPC del mes base
gen ipc = 41.4811668395996094			/*  MES BASE: promedio Diciembre-Mayo	*/
