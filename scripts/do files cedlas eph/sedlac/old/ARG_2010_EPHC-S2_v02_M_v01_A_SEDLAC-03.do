...
notes iasalp_m:  relab = 2: 913 zero incomes - 0 missing observations
...
notes ictapp_m:  relab = 3: 206 zero incomes - 0 missing observations
...
gen	lp_extrema = 176.49		if  trimestre==3		/*( modificar cada semestre	)*/                  
replace lp_extrema = 186.03		if  trimestre==4                
...
gen	lp_moderada = 383.91		if  trimestre==3		/*( modificar cada semestre	)*/                 
replace lp_moderada = 402.18		if  trimestre==4                
...
* IPC del mes base
gen ipc = 105.1781005859375	/*  MES BASE: promedio Junio-Noviembre	*/
