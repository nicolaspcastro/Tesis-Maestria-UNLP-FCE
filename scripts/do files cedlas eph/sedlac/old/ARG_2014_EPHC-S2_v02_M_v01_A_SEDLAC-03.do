...
notes iasalp_m:  relab = 2: 813 zero incomes - 0 missing observations
...
notes ictapp_m:  relab = 3: 238 zero incomes - 0 missing observations
...
notes ipatrp_m:  relab = 1: 34 zero incomes - 0 missing observations
...
gen	lp_extrema = 303.64		if  trimestre==3	/*( modificar cada semestre	)*/                  
replace lp_extrema = 314.96		if  trimestre==4                
...
gen	lp_moderada = 690.63		if  trimestre==3	/*( modificar cada semestre	)*/                 
replace lp_moderada = 716.38		if  trimestre==4                
...
* IPC del mes base
gen ipc = 285.221165974934877	/*  MES BASE: promedio Junio-Noviembre	*/
