...
notes iasalp_m:  relab = 2: 2257 zero incomes - 0 missing observations
...
notes ictapp_m:  relab = 3: 345 zero incomes - 0 missing observations
...
notes ipatrp_m:  relab = 1: 55 zero incomes - 0 missing observations
...
gen	lp_extrema = 138.27		if  trimestre==1		/*( modificar cada semestre	)*/                  
replace lp_extrema = 138.72		if  trimestre==2                
...
gen	lp_moderada = 296.81		if  trimestre==1		/*( modificar cada semestre	)*/                 
replace lp_moderada = 297.80		if  trimestre==2                
...
* IPC del mes base
gen ipc = 51.9984747568766252			/*  MES BASE: promedio Diciembre-Mayo	*/
