...
notes iasalp_m:  relab = 2: 3255 zero incomes - 0 missing observations
...
notes ictapp_m:  relab = 3: 381 zero incomes - 0 missing observations
...
notes ipatrp_m:  relab = 1: 50 zero incomes - 0 missing observations
...
gen	lp_extrema = 107.53		if  trimestre==3	/*( modificar cada semestre	)*/                  
replace lp_extrema = 108.24		if  trimestre==4                
...
gen	lp_moderada = 236.19		if  trimestre==3	/*( modificar cada semestre	)*/                 
replace lp_moderada = 238.48		if  trimestre==4                
...
* IPC del mes base
gen ipc = 39.4404570261637346			/*  MES BASE: promedio Junio-Noviembre	*/
