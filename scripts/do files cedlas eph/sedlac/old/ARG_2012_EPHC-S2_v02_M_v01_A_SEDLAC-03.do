...
notes iasalp_m:  relab = 2: 694 zero incomes - 0 missing observations
...
notes ictapp_m:  relab = 3: 172 zero incomes - 0 missing observations
...
notes ipatrp_m:  relab = 1: 27 zero incomes - 0 missing observations
...
gen	lp_extrema = 226.00		if  trimestre==3		/*( modificar cada semestre	)*/                  
replace lp_extrema = 231.77		if  trimestre==4                
...
gen	lp_moderada = 502.67		if  trimestre==3		/*( modificar cada semestre	)*/                 
replace lp_moderada = 517.93		if  trimestre==4                
...
* IPC del mes base
gen ipc = 160.405235290527344			/*  MES BASE: promedio Junio-Noviembre	*/
