...
notes iasalp_m:  relab = 2: 892 zero incomes - 0 missing observations
...
notes ictapp_m:  relab = 3: 247 zero incomes - 0 missing observations
...
notes ipatrp_m:  relab = 1: 28 zero incomes - 0 missing observations
...
gen	lp_extrema = 188.34		if  trimestre==1		/*( modificar cada semestre	)*/                  
replace lp_extrema = 192.02		if  trimestre==2                
...
gen	lp_moderada = 412.13		if  trimestre==1		/*( modificar cada semestre	)*/                 
replace lp_moderada = 422.55		if  trimestre==2                
...
* IPC del mes base
gen ipc = 116.604028065999344			/*  MES BASE: promedio Diciembre-Mayo	*/
