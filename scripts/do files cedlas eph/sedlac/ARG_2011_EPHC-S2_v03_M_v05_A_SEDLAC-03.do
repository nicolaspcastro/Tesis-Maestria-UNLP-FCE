...
notes   sector1d: there are 146 missings observations with ocupado==1 in the variable sector1d
...
notes   sector: there are 146 missings observations with ocupado==1 in the variable sector
...
gen	lp_extrema =     .	
replace lp_extrema =  458.67		if  trimestre==3 		
replace lp_extrema =  474.94		if  trimestre==4 		
...
gen	lp_moderada =     .
replace lp_moderada = 1004.89		if  trimestre==3   
replace lp_moderada = 1053.78		if  trimestre==4   
...
* IPC del mes base
gen ipc = 127.975011189778			/*  MES BASE: promedio Junio-Noviembre	*/
