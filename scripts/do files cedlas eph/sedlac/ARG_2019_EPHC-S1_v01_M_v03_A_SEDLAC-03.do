...
notes   sector1d: there are 441 missings observations with ocupado==1 in the variable sector1d
...
notes   sector: there are 441 missings observations with ocupado==1 in the variable sector
...
* IPC del mes base
gen ipc = 1092.52133469058		/*  MES BASE: promedio Diciembre-Mayo	*/

gen cpiperiod = "2019m01-2019m06"

* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.947		if  trimestre==1
replace ipc_rel = 1.053		if  trimestre==2
