...
gen	lp_extrema =     .	
replace lp_extrema =  129.46		if  trimestre==3 		
replace lp_extrema =  135.54		if  trimestre==4 		
...
gen	lp_moderada =     .
replace lp_moderada =  341.95		if  trimestre==3   
replace lp_moderada =  354.75		if  trimestre==4    
...
* IPC del mes base
gen ipc = 43.6798623402913			/*  MES BASE: promedio Junio-Noviembre	*/

gen cpiperiod = "2005m07-2005m12"
    
* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.986		if  trimestre==3
replace ipc_rel = 1.014		if  trimestre==4
