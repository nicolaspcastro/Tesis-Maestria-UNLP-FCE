...
*************************************************************************************************************************************************)*/
* ARG 2007: Personas de 10 y más años de edad
...
gen	lp_extrema =     .	
replace lp_extrema =  153.45		if  trimestre==1 		
replace lp_extrema =  168.26		if  trimestre==2 		
...
gen	lp_moderada =     .
replace lp_moderada =  399.59		if  trimestre==1    
replace lp_moderada =  423.63		if  trimestre==2  
...
* IPC del mes base
gen ipc = 51.9984747568766			/*  MES BASE: promedio Diciembre-Mayo	*/

gen cpiperiod = "2007m01-2007m06"
   
* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.976		if  trimestre==1
replace ipc_rel = 1.024		if  trimestre==2
