...
notes   sector1d: there are 204 missings observations with ocupado==1 in the variable sector1d
...
notes   sector: there are 204 missings observations with ocupado==1 in the variable sector
...
replace v18_m_hd = .	if  v18_m_hd>9000
...
gen	lp_extrema =     .	
replace lp_extrema =  407.02		if  trimestre==1 		
replace lp_extrema =  434.67		if  trimestre==2 		
...
gen	lp_moderada =     .
replace lp_moderada =  911.06		if  trimestre==1    
replace lp_moderada =  961.39		if  trimestre==2  
...
* IPC del mes base
gen ipc = 116.604028065999			/*  MES BASE: promedio Diciembre-Mayo	*/

gen cpiperiod = "2011m01-2011m06"
 
* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.972		if  trimestre==1
replace ipc_rel = 1.028		if  trimestre==2
