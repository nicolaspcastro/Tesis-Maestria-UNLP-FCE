...
local year     	"2009"   	// Year of the survey
...
*************************************************************************************************************************************************)*/
* ARG 2009: Personas de 10 y más años de edad
...
replace sector1d = 5		if (rama>=40 & rama<=41) | (rama>=4000 & rama<=4200)
...
replace v18_m_hd = .	if  v18_m_hd>10000
...
gen	lp_extrema =     .	
replace lp_extrema =  257.16		if  trimestre==3 		
replace lp_extrema =  272.57		if  trimestre==4 		
...
gen	lp_moderada =     .
replace lp_moderada =  661.58		if  trimestre==3    
replace lp_moderada =  686.98		if  trimestre==4    
...
* IPC del mes base
gen ipc = 84.4265022277831			/*  MES BASE: promedio Junio-Noviembre	*/

gen cpiperiod = "2009m07-2009m12"
    
* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.982		if  trimestre==3
replace ipc_rel = 1.018		if  trimestre==4
