...
gen	lp_extrema =     .	
replace lp_extrema =  499.05		if  trimestre==1 		
replace lp_extrema =  538.00		if  trimestre==2 		
...
gen	lp_moderada =     .
replace lp_moderada = 1113.10		if  trimestre==1   
replace lp_moderada = 1188.05		if  trimestre==2   
...
* IPC del mes base
gen ipc = 142.796844482421			/*  MES BASE: promedio Diciembre-Mayo	*/

gen cpiperiod = "2012m01-2012m06"
 
* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.968		if  trimestre==1
replace ipc_rel = 1.032		if  trimestre==2
