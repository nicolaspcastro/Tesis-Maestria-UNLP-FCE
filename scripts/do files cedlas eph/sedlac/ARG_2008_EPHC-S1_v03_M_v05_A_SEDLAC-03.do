...
gen	lp_extrema =     .	
replace lp_extrema =  212.85		if  trimestre==1 		
replace lp_extrema =  233.48		if  trimestre==2 		
...
gen	lp_moderada =     .
replace lp_moderada =  511.41		if  trimestre==1   
replace lp_moderada =  545.98		if  trimestre==2   
...
* IPC del mes base
gen ipc = 66.5511595408121			/*  MES BASE: promedio Junio-Noviembre	*/
