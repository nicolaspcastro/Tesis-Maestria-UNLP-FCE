...
notes   sector1d: there are 689 missings observations with ocupado==1 in the variable sector1d
...
notes   sector: there are 689 missings observations with ocupado==1 in the variable sector
...
gen     lp_extrema = 2251.02		if  trimestre==1 & gba==1           
replace lp_extrema = 2012.55		if  trimestre==1 & pampa==1         
replace lp_extrema = 2008.52		if  trimestre==1 & cuyo==1	    	
replace lp_extrema = 1960.36		if  trimestre==1 & noa==1	    	
replace lp_extrema = 2240.19		if  trimestre==1 & pata==1          
replace lp_extrema = 2327.43		if  trimestre==1 & nea==1           
							                    
replace	lp_extrema = 2421.40		if  trimestre==2 & gba==1           
replace lp_extrema = 2157.92		if  trimestre==2 & pampa==1         
replace lp_extrema = 2157.01		if  trimestre==2 & cuyo==1	    	
replace lp_extrema = 2096.08		if  trimestre==2 & noa==1	    	
replace lp_extrema = 2394.25		if  trimestre==2 & pata==1          
replace lp_extrema = 2494.25		if  trimestre==2 & nea==1           

* Linea de pobreza oficial moderada ("linea de pobreza")
gen     lp_moderada = 5650.38		if  trimestre==1 & gba==1           
replace lp_moderada = 5373.78		if  trimestre==1 & pampa==1         
replace lp_moderada = 4720.33		if  trimestre==1 & cuyo==1	    
replace lp_moderada = 4567.94		if  trimestre==1 & noa==1	    
replace lp_moderada = 5623.16		if  trimestre==1 & pata==1          
replace lp_moderada = 6625.94		if  trimestre==1 & nea==1           
							                    
replace	lp_moderada = 6115.79		if  trimestre==2 & gba==1           
replace lp_moderada = 5481.17		if  trimestre==2 & pampa==1         
replace lp_moderada = 5096.03		if  trimestre==2 & cuyo==1	    
replace lp_moderada = 4910.16		if  trimestre==2 & noa==1	    
replace lp_moderada = 6047.17		if  trimestre==2 & pata==1          
replace lp_moderada = 7147.78		if  trimestre==2 & nea==1           
...
* IPC del mes base
gen ipc = 708.821075361786	/*  MES BASE: promedio Enero-Junio	*/

gen cpiperiod = "2018m01-2018m06"
