...
*************************************************************************************************************************************************)*/
* ARG 2006: Personas de 10 y más años de edad
...
replace v18_m_hd = .	if  v18_m_hd>2500
...
gen	lp_extrema =     .	
replace lp_extrema =  139.64		if  trimestre==1 	
replace lp_extrema =  139.35		if  trimestre==2 		
...
gen	lp_moderada =     .
replace lp_moderada =  365.59		if  trimestre==1  
replace lp_moderada =  367.43		if  trimestre==2   
...
* IPC del mes base
gen ipc = 46.2471981048584			/*  MES BASE: promedio Diciembre-Mayo	*/

gen cpiperiod = "2006m01-2006m06"
   
* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.987		if  trimestre==1
replace ipc_rel = 1.013		if  trimestre==2
