...
replace v18_m_hd = .	if  v18_m_hd>6000
...
gen	lp_extrema =     .	
replace lp_extrema =  319.35		if  trimestre==1 		
replace lp_extrema =  344.18		if  trimestre==2 		
...
gen	lp_moderada =     .
replace lp_moderada =  735.77		if  trimestre==1   
replace lp_moderada =  781.53		if  trimestre==2   
...
* IPC del mes base
gen ipc = 94.8218981424967		/*  MES BASE: promedio Diciembre-Mayo	*/

gen cpiperiod = "2010m01-2010m06"
 
* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.965		if  trimestre==1
replace ipc_rel = 1.035		if  trimestre==2
