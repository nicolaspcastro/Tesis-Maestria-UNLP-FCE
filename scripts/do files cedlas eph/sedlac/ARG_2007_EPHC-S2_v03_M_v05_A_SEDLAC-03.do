...
gen	lp_extrema =     .	
replace lp_extrema =  190.56		if  trimestre==3 		
replace lp_extrema =  196.80		if  trimestre==4 		
...
gen	lp_moderada =     .
replace lp_moderada =  454.68		if  trimestre==3    
replace lp_moderada =  481.48		if  trimestre==4   
...
* IPC del mes base
gen ipc = 59.0265744527181			/*  MES BASE: promedio Junio-Noviembre	*/

gen cpiperiod = "2007m07-2007m12"
    
* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.970		if  trimestre==3
replace ipc_rel = 1.030		if  trimestre==4
