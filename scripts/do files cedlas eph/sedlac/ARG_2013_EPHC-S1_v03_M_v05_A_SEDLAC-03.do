...
notes   sector1d: there are 152 missings observations with ocupado==1 in the variable sector1d
...
notes   sector: there are 152 missings observations with ocupado==1 in the variable sector
...
replace v18_m_hd = .	if  v18_m_hd>2800
...
gen	lp_extrema =     .	
replace lp_extrema =  624.04		if  trimestre==1 		
replace lp_extrema =  656.32		if  trimestre==2 		
...
gen	lp_moderada =     .
replace lp_moderada = 1430.32		if  trimestre==1  
replace lp_moderada = 1504.40		if  trimestre==2 
...
* IPC del mes base
gen ipc = 181.475710550944			/*  MES BASE: promedio Diciembre-Mayo	*/

gen cpiperiod = "2013m01-2013m06"
 
* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.974		if  trimestre==1
replace ipc_rel = 1.026		if  trimestre==2
