...
local va       	"05"     	// Alternative version
...
*eplace water_source =  6	if  				          /* Protected spring		    */
*eplace water_source =  7	if  				          /* Bottled water		        */
*eplace water_source =  8	if  				          /* Rainwater			        */
*eplace water_source =  9	if  				          /* Unprotected spring		    */
replace water_source = 10	if  iv6==3 & iv7==3		      /* Unprotected dug well		*/
*eplace water_source = 11	if  				          /* Cart with small tank/drum	*/
*eplace water_source = 12	if  				          /* Tanker-truck			    */
*eplace water_source = 13	if  				          /* Surface water		        */	
replace water_source = 14	if (iv6==2 | iv6==3) & iv7==4 /* Other			            */

* All piped classification
gen     piped = 0
replace piped = 1		    if  inlist(iv6,1,2,3) & inlist(iv7,1,2)

* Piped to premises classification 
gen     piped_to_prem = 0
replace piped_to_prem = 1	if  inlist(iv6,1,2) & inlist(iv7,1,2)
...
*************************************************************************************************************************************************)*/
* ARG 2008: Personas de 10 y más años de edad
...
/* Razon por la que no pertenece a la fuerza de trabajo
	 ...
	 3 = Retired					 
	 4 = Disabled 
	 5 = Waiting for the work season		 
	 6 = Do not have the economic means 
	 7 = Do not have the legal means / Illegal	 
	 8 = Too old/young to work
	 9 = Do not have the need to work		
	10 = Forbidden by a family member
	11 = Illness					
	12 = Exhausted to be looking for a job
	13 = Believe none will give him/her a job       
	14 = Wages are too low
	99 = Other									
...
replace sector1d = 6		if  rama==45             |  rama==4500 | rama==4501
...
replace sector1d = 12	if  rama==75             | (rama>=7500 & rama<=7503)
...
*ArmonizaciÃ³n de ocupaciones a ISCO-2008
/* OCUPACION DEL TRABAJADOR

	Variable SEDLAC: tarea
	Variable EPHC:	 PP04D_COD
	CodificaciÃ³n:	 Clasificador Nacional de Ocupaciones - CNO-2001

Se convierten ocupaciones del CNO-01 a ISCO-08 con el crosswalk oficial del INDEC.
Este presenta 4 casos especiales donde el primer dÃ­gito de ISCO es 2, 3, 7 u 8 y
el segundo puede determinarse aproximadamente en combinaciÃ³n con informaciÃ³n de la
rama de actividad. Estos casos se presentan en string con (2). Algunos valores del
crosswalk de estos casos especiales remiten a los ISCOs 79 y 89 que no existen,
pero se les asigna un valor aproximado en base a los nombres de las ocupaciones 
(marcados con isco_adhoc=1). En el crosswalk oficial, los casos especiales usan la
clasificaciÃ³n CAES-MERCOSUR 1.0 para ramas de actividad. Esta clasificacion esta
en uso desde 2011. Entre el 2003 y el IV trimestre de 2010 las actividades economicas
se clasificaron en CAES-MERCOSUR: se usa el crosswalk oficial del INDEC de ramas
de actividad tambiÃ©n.
	
Documento CNO-01:
https://www.indec.gob.ar/ftp/cuadros/menusuperior/eph/EPHcontinua_CNO2001_reducido_09.pdf

Crosswalk oficial INDEC CNO-01 -- ISCO-08:
https://www.indec.gob.ar/ftp/cuadros/menusuperior/eph/CONVERSION_CNO-01_CIUO-08.xls

Crosswalk oficial INDEC CAES -- CAES 1.0:
https://www.indec.gob.ar/ftp/cuadros/menusuperior/clasificadores/tabla_correspondencias_caes_mercosur1.0_caes.xls

Documento CAES (2003-2010):
https://www.indec.gob.ar/ftp/cuadros/menusuperior/eph/EPHcontinua_CAES_Mercosur_09.pdf

Documento CAES 1.0 (2011-):
https://www.indec.gob.ar/ftp/cuadros/menusuperior/eph/caes_mercosur_1.0.pdf   */
gen cno01 = tarea
destring cno01, replace

gen 	isco08_2d = "."
replace isco08_2d = "01" if cno01 == 49311
replace isco08_2d = "01" if cno01 == 49331
replace isco08_2d = "02" if cno01 == 49312
replace isco08_2d = "02" if cno01 == 49322
replace isco08_2d = "02" if cno01 == 49332
replace isco08_2d = "03" if cno01 == 49313
replace isco08_2d = "03" if cno01 == 49314
replace isco08_2d = "03" if cno01 == 49323
replace isco08_2d = "03" if cno01 == 49333
replace isco08_2d = "11" if cno01 == 1
replace isco08_2d = "11" if cno01 == 1001
replace isco08_2d = "11" if cno01 == 4001
replace isco08_2d = "12" if cno01 == 56111
replace isco08_2d = "13" if cno01 == 3001
replace isco08_2d = "13" if cno01 == 5001
replace isco08_2d = "13" if cno01 == 6001
replace isco08_2d = "13" if cno01 == 7001
replace isco08_2d = "13" if cno01 == 57111
replace isco08_2d = "13" if cno01 == 65111
replace isco08_2d = "14" if cno01 == 5002
replace isco08_2d = "14" if cno01 == 51111
replace isco08_2d = "14" if cno01 == 51201
replace isco08_2d = "14" if cno01 == 52111
replace isco08_2d = "14" if cno01 == 53111
replace isco08_2d = "14" if cno01 == 58111
replace isco08_2d = "21" if cno01 == 34111
replace isco08_2d = "21" if cno01 == 34121
replace isco08_2d = "21" if cno01 == 34131
replace isco08_2d = "21" if cno01 == 34201
replace isco08_2d = "21" if cno01 == 34311
replace isco08_2d = "21" if cno01 == 34321
replace isco08_2d = "21" if cno01 == 34331
replace isco08_2d = "21" if cno01 == 35111
replace isco08_2d = "21" if cno01 == 35131
replace isco08_2d = "21" if cno01 == 35201
replace isco08_2d = "21" if cno01 == 35311
replace isco08_2d = "21" if cno01 == 36111
replace isco08_2d = "21" if cno01 == 36311
replace isco08_2d = "21" if cno01 == 60111
replace isco08_2d = "21" if cno01 == 60131
replace isco08_2d = "21" if cno01 == 60201
replace isco08_2d = "21" if cno01 == 60311
replace isco08_2d = "21" if cno01 == 60331
replace isco08_2d = "21" if cno01 == 61311
replace isco08_2d = "21" if cno01 == 62111
replace isco08_2d = "21" if cno01 == 62201
replace isco08_2d = "21" if cno01 == 62311
replace isco08_2d = "21" if cno01 == 63111
replace isco08_2d = "21" if cno01 == 63311
replace isco08_2d = "21" if cno01 == 64111
replace isco08_2d = "21" if cno01 == 64311
replace isco08_2d = "21" if cno01 == 70111
replace isco08_2d = "21" if cno01 == 70131
replace isco08_2d = "21" if cno01 == 70201
replace isco08_2d = "21" if cno01 == 70311
replace isco08_2d = "21" if cno01 == 70331
replace isco08_2d = "21" if cno01 == 71111
replace isco08_2d = "21" if cno01 == 71201
replace isco08_2d = "21" if cno01 == 71311
replace isco08_2d = "21" if cno01 == 72111
replace isco08_2d = "21" if cno01 == 72131
replace isco08_2d = "21" if cno01 == 72201
replace isco08_2d = "21" if cno01 == 72311
replace isco08_2d = "21" if cno01 == 72331
replace isco08_2d = "21" if cno01 == 80111
replace isco08_2d = "21" if cno01 == 80201
replace isco08_2d = "21" if cno01 == 80311
replace isco08_2d = "21" if cno01 == 82111
replace isco08_2d = "21" if cno01 == 90111
replace isco08_2d = "21" if cno01 == 90121
replace isco08_2d = "21" if cno01 == 90201
replace isco08_2d = "21" if cno01 == 90311
replace isco08_2d = "21" if cno01 == 90331
replace isco08_2d = "21" if cno01 == 91111
replace isco08_2d = "21" if cno01 == 91131
replace isco08_2d = "21" if cno01 == 91201
replace isco08_2d = "21" if cno01 == 91311
replace isco08_2d = "21" if cno01 == 91331
replace isco08_2d = "21" if cno01 == 92111
replace isco08_2d = "21" if cno01 == 92131
replace isco08_2d = "21" if cno01 == 92201
replace isco08_2d = "21" if cno01 == 92311
replace isco08_2d = "21" if cno01 == 92331
replace isco08_2d = "22" if cno01 == 30111
replace isco08_2d = "22" if cno01 == 30201
replace isco08_2d = "22" if cno01 == 30311
replace isco08_2d = "22" if cno01 == 40111
replace isco08_2d = "22" if cno01 == 40131
replace isco08_2d = "22" if cno01 == 40201
replace isco08_2d = "22" if cno01 == 40311
replace isco08_2d = "22" if cno01 == 40331
replace isco08_2d = "22" if cno01 == 44111
replace isco08_2d = "22" if cno01 == 44131
replace isco08_2d = "22" if cno01 == 44201
replace isco08_2d = "22" if cno01 == 44311
replace isco08_2d = "22" if cno01 == 61111
replace isco08_2d = "22" if cno01 == 61131
replace isco08_2d = "22" if cno01 == 61201
replace isco08_2d = "23" if cno01 == 41111
replace isco08_2d = "23" if cno01 == 41112
replace isco08_2d = "23" if cno01 == 41131
replace isco08_2d = "23" if cno01 == 41201
replace isco08_2d = "23" if cno01 == 41202
replace isco08_2d = "23" if cno01 == 41311
replace isco08_2d = "23" if cno01 == 41312
replace isco08_2d = "23" if cno01 == 41332
replace isco08_2d = "24" if cno01 == 10111
replace isco08_2d = "24" if cno01 == 10201
replace isco08_2d = "24" if cno01 == 10311
replace isco08_2d = "24" if cno01 == 10331
replace isco08_2d = "24" if cno01 == 20111
replace isco08_2d = "24" if cno01 == 20201
replace isco08_2d = "24" if cno01 == 20311
replace isco08_2d = "24" if cno01 == 20331
replace isco08_2d = "24" if cno01 == 31111
replace isco08_2d = "24" if cno01 == 31131
replace isco08_2d = "24" if cno01 == 31311
replace isco08_2d = "24" if cno01 == 32111
replace isco08_2d = "24" if cno01 == 32201
replace isco08_2d = "24" if cno01 == 32311
replace isco08_2d = "24" if cno01 == 32331
replace isco08_2d = "24" if cno01 == 54111
replace isco08_2d = "24" if cno01 == 54311
replace isco08_2d = "25" if cno01 == 47111
replace isco08_2d = "25" if cno01 == 47131
replace isco08_2d = "25" if cno01 == 47201
replace isco08_2d = "25" if cno01 == 47331
replace isco08_2d = "25" if cno01 == 81131
replace isco08_2d = "25" if cno01 == 81201
replace isco08_2d = "25" if cno01 == 81331
replace isco08_2d = "26" if cno01 == 2001
replace isco08_2d = "26" if cno01 == 11111
replace isco08_2d = "26" if cno01 == 11201
replace isco08_2d = "26" if cno01 == 11311
replace isco08_2d = "26" if cno01 == 45111
replace isco08_2d = "26" if cno01 == 45112
replace isco08_2d = "26" if cno01 == 45121
replace isco08_2d = "26" if cno01 == 45201
replace isco08_2d = "26" if cno01 == 45202
replace isco08_2d = "26" if cno01 == 45311
replace isco08_2d = "26" if cno01 == 45312
replace isco08_2d = "26" if cno01 == 46111
replace isco08_2d = "26" if cno01 == 46112
replace isco08_2d = "26" if cno01 == 46201
replace isco08_2d = "26" if cno01 == 46311
replace isco08_2d = "26" if cno01 == 50111
replace isco08_2d = "26" if cno01 == 50131
replace isco08_2d = "26" if cno01 == 50201
replace isco08_2d = "26" if cno01 == 50311
replace isco08_2d = "26" if cno01 == 50331
replace isco08_2d = "31" if cno01 == 34112
replace isco08_2d = "31" if cno01 == 34122
replace isco08_2d = "31" if cno01 == 34202
replace isco08_2d = "31" if cno01 == 34312
replace isco08_2d = "31" if cno01 == 34322
replace isco08_2d = "31" if cno01 == 34332
replace isco08_2d = "31" if cno01 == 36112
replace isco08_2d = "31" if cno01 == 36202
replace isco08_2d = "31" if cno01 == 36312
replace isco08_2d = "31" if cno01 == 36332
replace isco08_2d = "31" if cno01 == 44122
replace isco08_2d = "31" if cno01 == 44132
replace isco08_2d = "31" if cno01 == 44322
replace isco08_2d = "31" if cno01 == 44323
replace isco08_2d = "31" if cno01 == 44332
replace isco08_2d = "31" if cno01 == 44333
replace isco08_2d = "31" if cno01 == 61112
replace isco08_2d = "31" if cno01 == 61312
replace isco08_2d = "31" if cno01 == 62112
replace isco08_2d = "31" if cno01 == 62312
replace isco08_2d = "31" if cno01 == 63112
replace isco08_2d = "31" if cno01 == 63312
replace isco08_2d = "31" if cno01 == 64112
replace isco08_2d = "31" if cno01 == 64202
replace isco08_2d = "31" if cno01 == 64312
replace isco08_2d = "31" if cno01 == 65112
replace isco08_2d = "31" if cno01 == 70112
replace isco08_2d = "31" if cno01 == 70122
replace isco08_2d = "31" if cno01 == 70132
replace isco08_2d = "31" if cno01 == 70202
replace isco08_2d = "31" if cno01 == 70203
replace isco08_2d = "31" if cno01 == 70312
replace isco08_2d = "31" if cno01 == 70322
replace isco08_2d = "31" if cno01 == 70332
replace isco08_2d = "31" if cno01 == 71112
replace isco08_2d = "31" if cno01 == 71113
replace isco08_2d = "31" if cno01 == 71122
replace isco08_2d = "31" if cno01 == 71123
replace isco08_2d = "31" if cno01 == 71133
replace isco08_2d = "31" if cno01 == 71202
replace isco08_2d = "31" if cno01 == 71203
replace isco08_2d = "31" if cno01 == 71312
replace isco08_2d = "31" if cno01 == 71313
replace isco08_2d = "31" if cno01 == 71322
replace isco08_2d = "31" if cno01 == 71323
replace isco08_2d = "31" if cno01 == 71332
replace isco08_2d = "31" if cno01 == 71333
replace isco08_2d = "31" if cno01 == 72112
replace isco08_2d = "31" if cno01 == 72202
replace isco08_2d = "31" if cno01 == 72203
replace isco08_2d = "31" if cno01 == 72312
replace isco08_2d = "31" if cno01 == 72332
replace isco08_2d = "31" if cno01 == 80132
replace isco08_2d = "31" if cno01 == 80202
replace isco08_2d = "31" if cno01 == 80203
replace isco08_2d = "31" if cno01 == 80312
replace isco08_2d = "31" if cno01 == 80322
replace isco08_2d = "31" if cno01 == 80332
replace isco08_2d = "31" if cno01 == 82132
replace isco08_2d = "31" if cno01 == 82202
replace isco08_2d = "31" if cno01 == 82332
replace isco08_2d = "31" if cno01 == 90112
replace isco08_2d = "31" if cno01 == 90122
replace isco08_2d = "31" if cno01 == 90202
replace isco08_2d = "31" if cno01 == 90312
replace isco08_2d = "31" if cno01 == 90332
replace isco08_2d = "31" if cno01 == 91112
replace isco08_2d = "31" if cno01 == 91123
replace isco08_2d = "31" if cno01 == 91202
replace isco08_2d = "31" if cno01 == 91312
replace isco08_2d = "31" if cno01 == 91313
replace isco08_2d = "31" if cno01 == 92202
replace isco08_2d = "32" if cno01 == 40112
replace isco08_2d = "32" if cno01 == 40122
replace isco08_2d = "32" if cno01 == 40132
replace isco08_2d = "32" if cno01 == 40202
replace isco08_2d = "32" if cno01 == 40312
replace isco08_2d = "32" if cno01 == 40322
replace isco08_2d = "32" if cno01 == 40332
replace isco08_2d = "32" if cno01 == 44112
replace isco08_2d = "33" if cno01 == 10112
replace isco08_2d = "33" if cno01 == 10122
replace isco08_2d = "33" if cno01 == 10132
replace isco08_2d = "33" if cno01 == 10202
replace isco08_2d = "33" if cno01 == 10312
replace isco08_2d = "33" if cno01 == 10332
replace isco08_2d = "33" if cno01 == 11332
replace isco08_2d = "33" if cno01 == 20112
replace isco08_2d = "33" if cno01 == 20122
replace isco08_2d = "33" if cno01 == 20132
replace isco08_2d = "33" if cno01 == 20202
replace isco08_2d = "33" if cno01 == 20312
replace isco08_2d = "33" if cno01 == 20332
replace isco08_2d = "33" if cno01 == 30112
replace isco08_2d = "33" if cno01 == 30202
replace isco08_2d = "33" if cno01 == 30312
replace isco08_2d = "33" if cno01 == 30332
replace isco08_2d = "33" if cno01 == 31112
replace isco08_2d = "33" if cno01 == 31202
replace isco08_2d = "33" if cno01 == 31312
replace isco08_2d = "33" if cno01 == 32112
replace isco08_2d = "33" if cno01 == 32202
replace isco08_2d = "33" if cno01 == 32312
replace isco08_2d = "33" if cno01 == 32332
replace isco08_2d = "33" if cno01 == 47112
replace isco08_2d = "33" if cno01 == 47202
replace isco08_2d = "33" if cno01 == 47312
replace isco08_2d = "33" if cno01 == 48332
replace isco08_2d = "34" if cno01 == 11112
replace isco08_2d = "34" if cno01 == 11202
replace isco08_2d = "34" if cno01 == 11312
replace isco08_2d = "34" if cno01 == 46132
replace isco08_2d = "34" if cno01 == 46202
replace isco08_2d = "34" if cno01 == 46203
replace isco08_2d = "34" if cno01 == 46312
replace isco08_2d = "34" if cno01 == 46313
replace isco08_2d = "34" if cno01 == 50112
replace isco08_2d = "34" if cno01 == 50113
replace isco08_2d = "34" if cno01 == 50122
replace isco08_2d = "34" if cno01 == 50202
replace isco08_2d = "34" if cno01 == 50312
replace isco08_2d = "34" if cno01 == 50313
replace isco08_2d = "34" if cno01 == 50322
replace isco08_2d = "34" if cno01 == 51112
replace isco08_2d = "34" if cno01 == 51202
replace isco08_2d = "34" if cno01 == 51312
replace isco08_2d = "34" if cno01 == 51322
replace isco08_2d = "34" if cno01 == 51332
replace isco08_2d = "34" if cno01 == 52112
replace isco08_2d = "34" if cno01 == 52122
replace isco08_2d = "34" if cno01 == 52123
replace isco08_2d = "34" if cno01 == 52133
replace isco08_2d = "34" if cno01 == 52202
replace isco08_2d = "34" if cno01 == 52312
replace isco08_2d = "34" if cno01 == 52322
replace isco08_2d = "34" if cno01 == 52323
replace isco08_2d = "34" if cno01 == 52333
replace isco08_2d = "34" if cno01 == 53112
replace isco08_2d = "34" if cno01 == 53132
replace isco08_2d = "34" if cno01 == 53202
replace isco08_2d = "34" if cno01 == 53312
replace isco08_2d = "34" if cno01 == 58112
replace isco08_2d = "34" if cno01 == 58122
replace isco08_2d = "34" if cno01 == 58202
replace isco08_2d = "34" if cno01 == 58312
replace isco08_2d = "35" if cno01 == 35112
replace isco08_2d = "35" if cno01 == 35122
replace isco08_2d = "35" if cno01 == 35132
replace isco08_2d = "35" if cno01 == 35202
replace isco08_2d = "35" if cno01 == 35312
replace isco08_2d = "35" if cno01 == 35322
replace isco08_2d = "35" if cno01 == 35332
replace isco08_2d = "35" if cno01 == 45113
replace isco08_2d = "35" if cno01 == 45122
replace isco08_2d = "35" if cno01 == 45123
replace isco08_2d = "35" if cno01 == 45132
replace isco08_2d = "35" if cno01 == 45133
replace isco08_2d = "35" if cno01 == 45313
replace isco08_2d = "35" if cno01 == 45322
replace isco08_2d = "35" if cno01 == 45323
replace isco08_2d = "35" if cno01 == 45332
replace isco08_2d = "35" if cno01 == 45333
replace isco08_2d = "35" if cno01 == 47322
replace isco08_2d = "35" if cno01 == 47332
replace isco08_2d = "35" if cno01 == 48322
replace isco08_2d = "35" if cno01 == 48331
replace isco08_2d = "35" if cno01 == 50132
replace isco08_2d = "35" if cno01 == 50332
replace isco08_2d = "35" if cno01 == 58332
replace isco08_2d = "35" if cno01 == 81132
replace isco08_2d = "35" if cno01 == 81202
replace isco08_2d = "35" if cno01 == 81332
replace isco08_2d = "35" if cno01 == 92112
replace isco08_2d = "35" if cno01 == 92132
replace isco08_2d = "35" if cno01 == 92312
replace isco08_2d = "35" if cno01 == 92332
replace isco08_2d = "41" if cno01 == 10113
replace isco08_2d = "41" if cno01 == 10123
replace isco08_2d = "41" if cno01 == 10133
replace isco08_2d = "41" if cno01 == 10203
replace isco08_2d = "41" if cno01 == 10313
replace isco08_2d = "41" if cno01 == 10333
replace isco08_2d = "41" if cno01 == 11113
replace isco08_2d = "41" if cno01 == 11123
replace isco08_2d = "41" if cno01 == 11203
replace isco08_2d = "41" if cno01 == 11313
replace isco08_2d = "41" if cno01 == 11314
replace isco08_2d = "41" if cno01 == 11333
replace isco08_2d = "41" if cno01 == 81133
replace isco08_2d = "41" if cno01 == 81203
replace isco08_2d = "41" if cno01 == 81333
replace isco08_2d = "42" if cno01 == 20113
replace isco08_2d = "42" if cno01 == 20203
replace isco08_2d = "42" if cno01 == 35323
replace isco08_2d = "42" if cno01 == 42113
replace isco08_2d = "42" if cno01 == 42313
replace isco08_2d = "42" if cno01 == 52203
replace isco08_2d = "42" if cno01 == 52313
replace isco08_2d = "42" if cno01 == 54113
replace isco08_2d = "42" if cno01 == 54202
replace isco08_2d = "42" if cno01 == 54313
replace isco08_2d = "42" if cno01 == 54323
replace isco08_2d = "43" if cno01 == 20133
replace isco08_2d = "43" if cno01 == 20333
replace isco08_2d = "43" if cno01 == 34113
replace isco08_2d = "43" if cno01 == 34203
replace isco08_2d = "43" if cno01 == 34313
replace isco08_2d = "43" if cno01 == 36113
replace isco08_2d = "43" if cno01 == 36203
replace isco08_2d = "43" if cno01 == 36313
replace isco08_2d = "43" if cno01 == 36333
replace isco08_2d = "44" if cno01 == 35113
replace isco08_2d = "44" if cno01 == 35123
replace isco08_2d = "44" if cno01 == 35133
replace isco08_2d = "44" if cno01 == 35203
replace isco08_2d = "44" if cno01 == 35313
replace isco08_2d = "44" if cno01 == 35314
replace isco08_2d = "44" if cno01 == 35333
replace isco08_2d = "44" if cno01 == 43313
replace isco08_2d = "51" if cno01 == 46113
replace isco08_2d = "51" if cno01 == 51113
replace isco08_2d = "51" if cno01 == 51203
replace isco08_2d = "51" if cno01 == 51313
replace isco08_2d = "51" if cno01 == 53113
replace isco08_2d = "51" if cno01 == 53203
replace isco08_2d = "51" if cno01 == 53313
replace isco08_2d = "51" if cno01 == 53323
replace isco08_2d = "51" if cno01 == 54112
replace isco08_2d = "51" if cno01 == 54122
replace isco08_2d = "51" if cno01 == 54312
replace isco08_2d = "51" if cno01 == 55113
replace isco08_2d = "51" if cno01 == 55203
replace isco08_2d = "51" if cno01 == 56202
replace isco08_2d = "51" if cno01 == 56203
replace isco08_2d = "51" if cno01 == 56313
replace isco08_2d = "51" if cno01 == 57112
replace isco08_2d = "51" if cno01 == 57113
replace isco08_2d = "51" if cno01 == 57123
replace isco08_2d = "51" if cno01 == 57202
replace isco08_2d = "51" if cno01 == 57203
replace isco08_2d = "51" if cno01 == 57312
replace isco08_2d = "51" if cno01 == 57313
replace isco08_2d = "51" if cno01 == 57323
replace isco08_2d = "51" if cno01 == 57333
replace isco08_2d = "51" if cno01 == 58203
replace isco08_2d = "52" if cno01 == 20313
replace isco08_2d = "52" if cno01 == 30113
replace isco08_2d = "52" if cno01 == 30133
replace isco08_2d = "52" if cno01 == 30203
replace isco08_2d = "52" if cno01 == 30313
replace isco08_2d = "52" if cno01 == 30314
replace isco08_2d = "52" if cno01 == 30323
replace isco08_2d = "52" if cno01 == 30333
replace isco08_2d = "52" if cno01 == 31113
replace isco08_2d = "52" if cno01 == 31203
replace isco08_2d = "52" if cno01 == 31313
replace isco08_2d = "52" if cno01 == 31314
replace isco08_2d = "52" if cno01 == 32113
replace isco08_2d = "52" if cno01 == 32123
replace isco08_2d = "52" if cno01 == 32203
replace isco08_2d = "52" if cno01 == 32313
replace isco08_2d = "52" if cno01 == 32314
replace isco08_2d = "52" if cno01 == 32323
replace isco08_2d = "52" if cno01 == 33203
replace isco08_2d = "52" if cno01 == 33314
replace isco08_2d = "53" if cno01 == 40113
replace isco08_2d = "53" if cno01 == 40203
replace isco08_2d = "53" if cno01 == 40313
replace isco08_2d = "53" if cno01 == 40314
replace isco08_2d = "53" if cno01 == 40323
replace isco08_2d = "53" if cno01 == 41113
replace isco08_2d = "53" if cno01 == 41203
replace isco08_2d = "53" if cno01 == 41313
replace isco08_2d = "53" if cno01 == 41323
replace isco08_2d = "53" if cno01 == 41333
replace isco08_2d = "53" if cno01 == 52113
replace isco08_2d = "53" if cno01 == 57314
replace isco08_2d = "54" if cno01 == 44202
replace isco08_2d = "54" if cno01 == 44203
replace isco08_2d = "54" if cno01 == 44312
replace isco08_2d = "54" if cno01 == 44313
replace isco08_2d = "54" if cno01 == 47113
replace isco08_2d = "54" if cno01 == 47203
replace isco08_2d = "54" if cno01 == 47313
replace isco08_2d = "54" if cno01 == 47314
replace isco08_2d = "54" if cno01 == 47323
replace isco08_2d = "54" if cno01 == 47333
replace isco08_2d = "54" if cno01 == 48311
replace isco08_2d = "54" if cno01 == 48312
replace isco08_2d = "54" if cno01 == 48313
replace isco08_2d = "54" if cno01 == 48323
replace isco08_2d = "54" if cno01 == 48333
replace isco08_2d = "61" if cno01 == 60112
replace isco08_2d = "61" if cno01 == 60113
replace isco08_2d = "61" if cno01 == 60202
replace isco08_2d = "61" if cno01 == 60203
replace isco08_2d = "61" if cno01 == 60312
replace isco08_2d = "61" if cno01 == 60313
replace isco08_2d = "61" if cno01 == 61113
replace isco08_2d = "61" if cno01 == 61123
replace isco08_2d = "61" if cno01 == 61133
replace isco08_2d = "61" if cno01 == 61202
replace isco08_2d = "61" if cno01 == 61203
replace isco08_2d = "61" if cno01 == 61313
replace isco08_2d = "61" if cno01 == 61323
replace isco08_2d = "61" if cno01 == 62202
replace isco08_2d = "61" if cno01 == 63113
replace isco08_2d = "61" if cno01 == 63123
replace isco08_2d = "61" if cno01 == 63202
replace isco08_2d = "61" if cno01 == 63203
replace isco08_2d = "61" if cno01 == 63313
replace isco08_2d = "61" if cno01 == 63323
replace isco08_2d = "61" if cno01 == 63333
replace isco08_2d = "62" if cno01 == 62113
replace isco08_2d = "62" if cno01 == 62203
replace isco08_2d = "62" if cno01 == 62313
replace isco08_2d = "62" if cno01 == 64113
replace isco08_2d = "62" if cno01 == 64203
replace isco08_2d = "62" if cno01 == 64313
replace isco08_2d = "62" if cno01 == 64323
replace isco08_2d = "62" if cno01 == 65113
replace isco08_2d = "62" if cno01 == 65313
replace isco08_2d = "71" if cno01 == 70113
replace isco08_2d = "71" if cno01 == 72113
replace isco08_2d = "71" if cno01 == 72313
replace isco08_2d = "72" if cno01 == 82113
replace isco08_2d = "72" if cno01 == 82133
replace isco08_2d = "72" if cno01 == 82203
replace isco08_2d = "72" if cno01 == 82313
replace isco08_2d = "72" if cno01 == 82333
replace isco08_2d = "72" if cno01 == 90113
replace isco08_2d = "72" if cno01 == 90123
replace isco08_2d = "72" if cno01 == 90203
replace isco08_2d = "72" if cno01 == 90313
replace isco08_2d = "72" if cno01 == 90323
replace isco08_2d = "72" if cno01 == 92113
replace isco08_2d = "72" if cno01 == 92203
replace isco08_2d = "72" if cno01 == 92313
replace isco08_2d = "72" if cno01 == 92323
replace isco08_2d = "73" if cno01 == 80112
replace isco08_2d = "74" if cno01 == 82112
replace isco08_2d = "74" if cno01 == 82312
replace isco08_2d = "75" if cno01 == 44113
replace isco08_2d = "75" if cno01 == 82123
replace isco08_2d = "75" if cno01 == 82323
replace isco08_2d = "81" if cno01 == 56123
replace isco08_2d = "81" if cno01 == 56323
replace isco08_2d = "81" if cno01 == 56324
replace isco08_2d = "81" if cno01 == 70123
replace isco08_2d = "81" if cno01 == 70313
replace isco08_2d = "81" if cno01 == 70323
replace isco08_2d = "81" if cno01 == 70333
replace isco08_2d = "83" if cno01 == 34123
replace isco08_2d = "83" if cno01 == 34323
replace isco08_2d = "83" if cno01 == 36123
replace isco08_2d = "83" if cno01 == 36323
replace isco08_2d = "83" if cno01 == 58123
replace isco08_2d = "83" if cno01 == 58333
replace isco08_2d = "83" if cno01 == 60122
replace isco08_2d = "83" if cno01 == 60123
replace isco08_2d = "83" if cno01 == 60132
replace isco08_2d = "83" if cno01 == 60322
replace isco08_2d = "83" if cno01 == 60323
replace isco08_2d = "83" if cno01 == 62123
replace isco08_2d = "83" if cno01 == 62322
replace isco08_2d = "83" if cno01 == 62323
replace isco08_2d = "83" if cno01 == 62332
replace isco08_2d = "83" if cno01 == 72122
replace isco08_2d = "83" if cno01 == 72123
replace isco08_2d = "83" if cno01 == 72132
replace isco08_2d = "83" if cno01 == 72322
replace isco08_2d = "83" if cno01 == 72323
replace isco08_2d = "83" if cno01 == 72333
replace isco08_2d = "91" if cno01 == 55313
replace isco08_2d = "91" if cno01 == 55314
replace isco08_2d = "91" if cno01 == 56113
replace isco08_2d = "91" if cno01 == 56114
replace isco08_2d = "91" if cno01 == 56314
replace isco08_2d = "92" if cno01 == 58113
replace isco08_2d = "92" if cno01 == 58313
replace isco08_2d = "92" if cno01 == 58323
replace isco08_2d = "92" if cno01 == 60114
replace isco08_2d = "92" if cno01 == 60314
replace isco08_2d = "92" if cno01 == 60324
replace isco08_2d = "92" if cno01 == 61314
replace isco08_2d = "92" if cno01 == 62314
replace isco08_2d = "92" if cno01 == 62324
replace isco08_2d = "92" if cno01 == 63314
replace isco08_2d = "92" if cno01 == 64314
replace isco08_2d = "92" if cno01 == 65314
replace isco08_2d = "93" if cno01 == 34314
replace isco08_2d = "93" if cno01 == 36114
replace isco08_2d = "93" if cno01 == 36314
replace isco08_2d = "93" if cno01 == 36324
replace isco08_2d = "93" if cno01 == 70314
replace isco08_2d = "93" if cno01 == 71314
replace isco08_2d = "93" if cno01 == 71324
replace isco08_2d = "93" if cno01 == 72114
replace isco08_2d = "93" if cno01 == 72314
replace isco08_2d = "93" if cno01 == 72324
replace isco08_2d = "93" if cno01 == 80314
replace isco08_2d = "93" if cno01 == 80324
replace isco08_2d = "93" if cno01 == 82314
replace isco08_2d = "93" if cno01 == 82324
replace isco08_2d = "93" if cno01 == 90314
replace isco08_2d = "93" if cno01 == 90324
replace isco08_2d = "93" if cno01 == 92314
replace isco08_2d = "93" if cno01 == 92324
replace isco08_2d = "94" if cno01 == 53314
replace isco08_2d = "95" if cno01 == 33114
replace isco08_2d = "96" if cno01 == 10314
replace isco08_2d = "96" if cno01 == 20314
replace isco08_2d = "96" if cno01 == 34324
replace isco08_2d = "96" if cno01 == 44314
replace isco08_2d = "96" if cno01 == 46314
replace isco08_2d = "96" if cno01 == 51314
replace isco08_2d = "96" if cno01 == 52314
replace isco08_2d = "96" if cno01 == 54314
replace isco08_2d = "96" if cno01 == 58314

** Casos especiales que requieren informaciÃ³n de la rama de actividad
gen 	ciuo08 = "."
replace ciuo08 =	"2(2)"	if cno01 ==	42111
replace ciuo08 =	"2(2)"	if cno01 ==	42131
replace ciuo08 =	"2(2)"	if cno01 ==	42201
replace ciuo08 =	"2(2)"	if cno01 ==	42311
replace ciuo08 =	"2(2)"	if cno01 ==	43111
replace ciuo08 =	"2(2)"	if cno01 ==	43201
replace ciuo08 =	"2(2)"	if cno01 ==	43311
replace ciuo08 =	"3(2)"	if cno01 ==	42112
replace ciuo08 =	"3(2)"	if cno01 ==	42123
replace ciuo08 =	"3(2)"	if cno01 ==	42132
replace ciuo08 =	"3(2)"	if cno01 ==	42133
replace ciuo08 =	"3(2)"	if cno01 ==	42202
replace ciuo08 =	"3(2)"	if cno01 ==	42312
replace ciuo08 =	"3(2)"	if cno01 ==	42323
replace ciuo08 =	"3(2)"	if cno01 ==	42332
replace ciuo08 =	"3(2)"	if cno01 ==	42333
replace ciuo08 =	"3(2)"	if cno01 ==	43112
replace ciuo08 =	"3(2)"	if cno01 ==	43132
replace ciuo08 =	"3(2)"	if cno01 ==	43312
replace ciuo08 =	"7(2)"	if cno01 ==	80113
replace ciuo08 =	"7(2)"	if cno01 ==	80313
replace ciuo08 =	"8(2)"	if cno01 ==	80123
replace ciuo08 =	"8(2)"	if cno01 ==	80133
replace ciuo08 =	"8(2)"	if cno01 ==	80323
replace ciuo08 =	"8(2)"	if cno01 ==	80333

gen ocup_str = pp04b_cod
tostring ocup_str, replace
gen caes_2d=substr(ocup_str,1,2)
destring ocup_str, gen(ocup_int)
destring caes_2d, replace force

* Caso 2(2)
replace isco08_2d = "21" if ocup_int == 7402 & ciuo08 == "2(2)"  
replace isco08_2d = "21" if caes_2d  == 73   & ciuo08 == "2(2)" 
replace isco08_2d = "22" if ocup_int == 8501 & ciuo08 == "2(2)" 
replace isco08_2d = "24" if ocup_int == 7404 & ciuo08 == "2(2)" 
replace isco08_2d = "24" if ocup_int == 7401 & ciuo08 == "2(2)" 
replace isco08_2d = "26" if ocup_int == 7409 & ciuo08 == "2(2)" 

* Caso 3(2)
replace isco08_2d = "31" if ocup_int == 7402 & ciuo08 == "3(2)"  
replace isco08_2d = "31" if caes_2d  == 73   & ciuo08 == "3(2)" 
replace isco08_2d = "32" if ocup_int == 8501 & ciuo08 == "3(2)" 
replace isco08_2d = "33" if ocup_int == 7501 & ciuo08 == "3(2)" 
replace isco08_2d = "33" if ocup_int == 7502 & ciuo08 == "3(2)" 	
replace isco08_2d = "34" if ocup_int == 7409 & ciuo08 == "3(2)" 

* Caso 7(2)
replace isco08_2d = "75" if ocup_int == 1501 & ciuo08 == "7(2)"  
replace isco08_2d = "75" if ocup_int == 1502 & ciuo08 == "7(2)"  
replace isco08_2d = "75" if ocup_int == 1503 & ciuo08 == "7(2)"  
replace isco08_2d = "75" if ocup_int == 1504 & ciuo08 == "7(2)"  
replace isco08_2d = "75" if caes_2d  == 16   & ciuo08 == "7(2)"  
replace isco08_2d = "75" if ocup_int == 1700 & ciuo08 == "7(2)"  
replace isco08_2d = "75" if caes_2d  == 18   & ciuo08 == "7(2)"  
replace isco08_2d = "75" if caes_2d  == 19   & ciuo08 == "7(2)"  
replace isco08_2d = "75" if caes_2d  == 20   & ciuo08 == "7(2)"  
replace isco08_2d = "79" if caes_2d  == 21   & ciuo08 == "7(2)"  
replace isco08_2d = "73" if ocup_int == 2200 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if ocup_int == 2301 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if ocup_int == 2302 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if ocup_int == 2303 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if ocup_int == 2401 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if ocup_int == 2403 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if ocup_int == 2409 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if caes_2d  == 25   & ciuo08 == "7(2)"  
replace isco08_2d = "73" if caes_2d  == 26   & ciuo08 == "7(2)"  
replace isco08_2d = "79" if ocup_int == 2700 & ciuo08 == "7(2)"  
replace isco08_2d = "72" if ocup_int == 2800 & ciuo08 == "7(2)"  
replace isco08_2d = "75" if caes_2d  == 30   & ciuo08 == "7(2)"  
replace isco08_2d = "75" if ocup_int == 3200 & ciuo08 == "7(2)"  
replace isco08_2d = "75" if ocup_int == 3300 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if ocup_int == 3100 & ciuo08 == "7(2)"  
replace isco08_2d = "72" if ocup_int == 2900 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if caes_2d  == 34   & ciuo08 == "7(2)"  
replace isco08_2d = "79" if ocup_int == 3501 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if ocup_int == 3502 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if ocup_int == 3503 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if ocup_int == 3509 & ciuo08 == "7(2)"  
replace isco08_2d = "75" if ocup_int == 3601 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if caes_2d  == 37   & ciuo08 == "7(2)"  
replace isco08_2d = "79" if ocup_int == 9000 & ciuo08 == "7(2)"  

* Caso 8(2)
replace isco08_2d = "81" if ocup_int == 1501 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if ocup_int == 1502 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if ocup_int == 1503 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if ocup_int == 1504 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if caes_2d  == 16   & ciuo08 == "8(2)"  
replace isco08_2d = "81" if ocup_int == 1700 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if caes_2d  == 18   & ciuo08 == "8(2)"  
replace isco08_2d = "81" if caes_2d  == 19   & ciuo08 == "8(2)"  
replace isco08_2d = "81" if caes_2d  == 20   & ciuo08 == "8(2)"  
replace isco08_2d = "81" if caes_2d  == 21   & ciuo08 == "8(2)"  
replace isco08_2d = "81" if ocup_int == 2200 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if ocup_int == 2301 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if ocup_int == 2302 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if ocup_int == 2303 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if ocup_int == 2401 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if ocup_int == 2403 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if ocup_int == 2409 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if caes_2d  == 25   & ciuo08 == "8(2)"  
replace isco08_2d = "81" if caes_2d  == 26   & ciuo08 == "8(2)"  
replace isco08_2d = "81" if ocup_int == 2700 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if ocup_int == 2800 & ciuo08 == "8(2)"  
replace isco08_2d = "82" if caes_2d  == 30   & ciuo08 == "8(2)"  
replace isco08_2d = "82" if ocup_int == 3200 & ciuo08 == "8(2)"  
replace isco08_2d = "82" if ocup_int == 3300 & ciuo08 == "8(2)"  
replace isco08_2d = "82" if ocup_int == 3100 & ciuo08 == "8(2)"  
replace isco08_2d = "82" if ocup_int == 2900 & ciuo08 == "8(2)"  
replace isco08_2d = "89" if caes_2d  == 34   & ciuo08 == "8(2)"  
replace isco08_2d = "89" if ocup_int == 3501 & ciuo08 == "8(2)"  
replace isco08_2d = "89" if ocup_int == 3502 & ciuo08 == "8(2)"  
replace isco08_2d = "89" if ocup_int == 3503 & ciuo08 == "8(2)"  
replace isco08_2d = "89" if ocup_int == 3509 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if ocup_int == 3601 & ciuo08 == "8(2)"  
replace isco08_2d = "89" if caes_2d  == 37   & ciuo08 == "8(2)"  
replace isco08_2d = "89" if ocup_int == 9000 & ciuo08 == "8(2)"  
	
**Casos 79 y 89 reemplazados por ISCOs ad-hoc
gen isco_adhoc = 0
replace isco_adhoc = 1 if (isco08_2d == "79" | isco08_2d == "89")
label var isco_adhoc "=1 if isco08_2d was 79 or 89 and the 2nd digit was approximated"

*isco08_2d=79
replace isco08_2d = "73" if isco08_2d == "79" & caes_2d  == 21   
replace isco08_2d = "75" if isco08_2d == "79" & ocup_int == 2301 
replace isco08_2d = "75" if isco08_2d == "79" & ocup_int == 2302 	
replace isco08_2d = "75" if isco08_2d == "79" & ocup_int == 2303 
replace isco08_2d = "75" if isco08_2d == "79" & ocup_int == 2401 
replace isco08_2d = "75" if isco08_2d == "79" & ocup_int == 2403 
replace isco08_2d = "75" if isco08_2d == "79" & ocup_int == 2409 
replace isco08_2d = "72" if isco08_2d == "79" & caes_2d  == 25   
replace isco08_2d = "72" if isco08_2d == "79" & ocup_int == 2700 
replace isco08_2d = "74" if isco08_2d == "79" & ocup_int == 3100 
replace isco08_2d = "72" if isco08_2d == "79" & caes_2d  == 34   
replace isco08_2d = "72" if isco08_2d == "79" & ocup_int == 3501 
replace isco08_2d = "72" if isco08_2d == "79" & ocup_int == 3502 
replace isco08_2d = "72" if isco08_2d == "79" & ocup_int == 3503 
replace isco08_2d = "72" if isco08_2d == "79" & ocup_int == 3509 
replace isco08_2d = "75" if isco08_2d == "79" & caes_2d  == 37   
replace isco08_2d = "75" if isco08_2d == "79" & ocup_int == 9000 
	
*isco08_2d=89
replace isco08_2d = "82" if isco08_2d == "89" & caes_2d  == 34   
replace isco08_2d = "82" if isco08_2d == "89" & ocup_int == 3501 
replace isco08_2d = "82" if isco08_2d == "89" & ocup_int == 3502 
replace isco08_2d = "82" if isco08_2d == "89" & ocup_int == 3503 
replace isco08_2d = "82" if isco08_2d == "89" & ocup_int == 3509 
replace isco08_2d = "83" if isco08_2d == "89" & caes_2d  == 37   
replace isco08_2d = "83" if isco08_2d == "89" & ocup_int == 9000 

format isco08_2d %2s
label var isco08_2d "Occupation code, ISCO 08 (2 digits)"

destring isco08_2d, replace
...
replace aux_asistencia = 1	if  v5_m>0 & v5_m<.
...
replace tot_p12_hd = tot_p12_hd-150             if  pj2_1==1 
gen      resto_pj2 = tot_p12_hd*(-1)            if  tot_p12_hd<0
replace tot_p12_hd = 0				if  tot_p12_hd<0

replace pp08d1_hd = pp08d1_hd-150		if  pj1_1==1 
gen     resto_pj1 = pp08d1_hd*(-1)              if  pp08d1_hd<0
replace pp08d1_hd = 0				if  pp08d1_hd<0 
replace pp08d1_hd = pp08d1_hd-resto_pj2         if  resto_pj2!=.
gen     resto_pj3 = pp08d1_hd*(-1)              if  pp08d1_hd<0
replace pp08d1_hd = 0				if  pp08d1_hd<0 
...
replace wage_base = .       if  ocupado!=1
...
gen	aux_subs = v5_m_hd
replace aux_subs = v5_m_hd-150	        if  pj3_1==1
replace aux_subs = v5_m_hd-resto_pj1	if  resto_pj1!=.
replace aux_subs = v5_m_hd-resto_pj3	if  resto_pj3!=.
replace aux_subs = .       	        if  aux_subs<0
...
replace v18_m_hd = .	if  v18_m_hd>9700
...
gen	lp_extrema =     .	
replace lp_extrema =  237.23		if  trimestre==3 		
replace lp_extrema =  238.72		if  trimestre==4 		
...
gen	lp_moderada =     .
replace lp_moderada =  578.95		if  trimestre==3   
replace lp_moderada =  600.12		if  trimestre==4   
...
* IPC del mes base
gen ipc = 74.0787251790364			/*  MES BASE: promedio Junio-Noviembre	*/

gen cpiperiod = "2008m07-2008m12"
    
* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.978		if  trimestre==3
replace ipc_rel = 1.022		if  trimestre==4
