...
replace sector1d = 4		if (rama>=10 & rama<=33) |  rama==58   | (rama>=1001 & rama<=3302) | rama==5800 | rama==9502
...
replace sector1d = 12		if (rama>=83 & rama<=84) | (rama>=8300 & rama<=8410)
...
notes   sector1d: there are 192 missings observations with ocupado==1 in the variable sector1d
...
notes   sector: there are 192 missings observations with ocupado==1 in the variable sector
...
replace v18_m_hd = .	if  v18_m_hd>20000
...
gen	lp_extrema =     .	
replace lp_extrema =  889.35		if  trimestre==1 		
replace lp_extrema =  960.77		if  trimestre==2 		
...
gen	lp_moderada =     .
replace lp_moderada = 1911.22		if  trimestre==1   
replace lp_moderada = 2077.83		if  trimestre==2  
...
* IPC del mes base
gen ipc = 245.809488932291	/*  MES BASE: promedio Enero-Junio	*/

gen cpiperiod = "2014m01-2014m06"
 
* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.951		if  trimestre==1
replace ipc_rel = 1.049		if  trimestre==2
