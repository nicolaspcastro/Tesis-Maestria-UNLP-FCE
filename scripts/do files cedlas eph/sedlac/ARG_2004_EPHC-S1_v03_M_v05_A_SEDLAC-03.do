...
local year     	"2004"   	// Year of the survey
...
*************************************************************************************************************************************************)*/
* ARG 2004: Personas de 10 y más años de edad
...
replace v18_m_hd = .	if  v18_m_hd>=1400
...
gen	lp_extrema =     .	
replace lp_extrema =  116.48		if  trimestre==1 		
replace lp_extrema =  117.24		if  trimestre==2 		
...
gen	lp_moderada =     .
replace lp_moderada =  309.12		if  trimestre==1    
replace lp_moderada =  311.14		if  trimestre==2    
...
* IPC del mes base
gen ipc = 38.2291997273762			/*  MES BASE: promedio Diciembre-Mayo	*/

gen cpiperiod = "2004m01-2004m06"
   
* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.992		if  trimestre==1
replace ipc_rel = 1.008		if  trimestre==2
