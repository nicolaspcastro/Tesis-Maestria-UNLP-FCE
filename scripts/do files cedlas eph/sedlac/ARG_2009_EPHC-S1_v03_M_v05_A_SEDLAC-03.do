...
replace v18_m_hd = .	if  v18_m_hd>3500
...
gen	lp_extrema =     .	
replace lp_extrema =  242.04		if  trimestre==1 	
replace lp_extrema =  250.34		if  trimestre==2 		
...
gen	lp_moderada =     .
replace lp_moderada =  621.72		if  trimestre==1    
replace lp_moderada =  640.90		if  trimestre==2   
...
* IPC del mes base
gen ipc = 79.187026977539			/*  MES BASE: promedio Diciembre-Mayo	*/

gen cpiperiod = "2009m01-2009m06"
  
* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.983		if  trimestre==1
replace ipc_rel = 1.017		if  trimestre==2
