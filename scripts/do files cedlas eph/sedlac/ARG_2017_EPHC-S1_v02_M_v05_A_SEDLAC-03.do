...
notes   sector1d: there are 624 missings observations with ocupado==1 in the variable sector1d
...
notes   sector: there are 624 missings observations with ocupado==1 in the variable sector
...
replace v18_m_hd = .		if  v18_m_hd>16000
...
gen     lp_extrema = 1828.91		if  trimestre==1 & gba==1
replace lp_extrema = 1635.08		if  trimestre==1 & pampa==1
replace lp_extrema = 1627.86		if  trimestre==1 & cuyo==1	
replace lp_extrema = 1578.59		if  trimestre==1 & noa==1	
replace lp_extrema = 1817.00		if  trimestre==1 & pata==1 
replace lp_extrema = 1890.23		if  trimestre==1 & nea==1

replace	lp_extrema = 1936.38		if  trimestre==2 & gba==1         
replace lp_extrema = 1731.19		if  trimestre==2 & pampa==1       
replace lp_extrema = 1727.42		if  trimestre==2 & cuyo==1	  	
replace lp_extrema = 1680.61		if  trimestre==2 & noa==1	  	
replace lp_extrema = 1921.31		if  trimestre==2 & pata==1        
replace lp_extrema = 1994.25		if  trimestre==2 & nea==1         

* Linea de pobreza oficial moderada ("linea de pobreza")
gen     lp_moderada = 4432.32	        if  trimestre==1 & gba==1         
replace lp_moderada = 4218.62	        if  trimestre==1 & pampa==1       
replace lp_moderada = 3695.33	        if  trimestre==1 & cuyo==1	   
replace lp_moderada = 3551.93	        if  trimestre==1 & noa==1	  
replace lp_moderada = 4403.46	        if  trimestre==1 & pata==1        
replace lp_moderada = 5198.24	        if  trimestre==1 & nea==1         

replace	lp_moderada = 4744.12	        if  trimestre==2 & gba==1         
replace lp_moderada = 4512.69	        if  trimestre==2 & pampa==1       
replace lp_moderada = 3961.60	        if  trimestre==2 & cuyo==1	   
replace lp_moderada = 3820.66	        if  trimestre==2 & noa==1	  
replace lp_moderada = 4700.88	        if  trimestre==2 & pata==1        
replace lp_moderada = 5550.71	        if  trimestre==2 & nea==1         
...
* IPC del mes base
gen ipc = 561.573176402252	/*  MES BASE: promedio Enero-Junio	*/

gen cpiperiod = "2017m01-2017m06"
