...
local year     	"2010"   	// Year of the survey
...
*************************************************************************************************************************************************)*/
* ARG 2010: Personas de 10 y más años de edad
...
replace sector1d = 8		if  rama==55             | (rama>=5500 & rama<=5600)
...
replace sector1d = 15		if (rama>=90 & rama<=93) | (rama>=9000 & rama<=9402)
...
replace v18_m_hd = .	if  v18_m_hd>7000
...
gen	lp_extrema =     .	
replace lp_extrema =  354.66			if  trimestre==3 		
replace lp_extrema =  392.56			if  trimestre==4 		
...
gen	lp_moderada =     .
replace lp_moderada =  820.64		if  trimestre==3    
replace lp_moderada =  865.35		if  trimestre==4    
...
* IPC del mes base
gen ipc = 105.178100585937	/*  MES BASE: promedio Junio-Noviembre	*/

gen cpiperiod = "2010m07-2010m12"
 
* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.975		if  trimestre==3
replace ipc_rel = 1.025		if  trimestre==4
