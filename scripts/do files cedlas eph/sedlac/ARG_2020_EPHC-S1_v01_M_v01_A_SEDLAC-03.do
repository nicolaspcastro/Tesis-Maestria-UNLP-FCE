...
replace agua = 0		if  iv6==3 | iv7==3 | iv7==4 
...
*eplace dweltyp = 2		if  iv1==
replace dweltyp = 3		if  iv1==2
*eplace dweltyp = 4		if  iv1==
replace dweltyp = 5		if  iv1==3 | iv1==4
*eplace dweltyp = 6		if  iv1== 
*eplace dweltyp = 7		if  iv1==
...
*eplace piso = 3		if  iv3==
replace piso = 4		if  iv3==1 
replace piso = 5		if  iv3==2 
*eplace piso = 6		if  iv3==
*eplace piso = 7		if  iv3==
...
* Estuvo enfermo en últimas 4 semanas?
gen   enfermo = .
notes enfermo: the survey does not include information on this topic

* Visitó médico en últimas 4 semanas? 
gen   visita = .
...
*************************************************************************************************************************************************)*/
* ARG 2020: Personas de 10 y más años de edad
...
*eplace nfl = 6		if  cat_inac==
*eplace nfl = 7		if  cat_inac==
replace nfl = 8		if  cat_inac==5
replace nfl = 9		if  cat_inac==2
*eplace nfl = 10	if  cat_inac==
*eplace nfl = 11	if  cat_inac==
replace nfl = 12		if  pp02e==3
*eplace nfl = 13	if  cat_inac==
*eplace nfl = 14	if  cat_inac==
...
notes   sector1d: there are 414 missings observations with ocupado==1 in the variable sector1d
...
notes   sector: there are 414 missings observations with ocupado==1 in the variable sector
...
**Soluciono los que estan a 3 digitos que generan problemas
replace ocup_str = "0101" if rama == 101
replace ocup_str = "0102" if rama == 102
replace ocup_str = "0103" if rama == 103
replace ocup_str = "0104" if rama == 104
replace ocup_str = "0105" if rama == 105
replace ocup_str = "0200" if rama == 200
replace ocup_str = "0300" if rama == 300
replace ocup_str = "0500" if rama == 500
replace ocup_str = "0600" if rama == 600
replace ocup_str = "0700" if rama == 700
replace ocup_str = "0800" if rama == 800
replace ocup_str = "0900" if rama == 900

gen 	 caes_2d=substr(ocup_str,1,2)
destring caes_2d, replace force

* Caso 2(2)
replace isco08_2d = "21" if caes_2d == 71 & ciuo08 == "2(2)"  
replace isco08_2d = "21" if caes_2d == 72 & ciuo08 == "2(2)"  
replace isco08_2d = "22" if caes_2d == 86 & ciuo08 == "2(2)"  
replace isco08_2d = "24" if caes_2d == 78 & ciuo08 == "2(2)"  
replace isco08_2d = "24" if caes_2d == 70 & ciuo08 == "2(2)"  
replace isco08_2d = "26" if caes_2d == 74 & ciuo08 == "2(2)"  

* Caso 3(2)
replace isco08_2d = "31" if caes_2d == 71 & ciuo08 == "3(2)"  
replace isco08_2d = "31" if caes_2d == 72 & ciuo08 == "3(2)"  
replace isco08_2d = "32" if caes_2d == 86 & ciuo08 == "3(2)"  
replace isco08_2d = "33" if caes_2d == 84 & ciuo08 == "3(2)"  
replace isco08_2d = "34" if caes_2d == 74 & ciuo08 == "3(2)"  

* Caso 7(2)
replace isco08_2d = "75" if caes_2d == 10 & ciuo08 == "7(2)"  
replace isco08_2d = "75" if caes_2d == 12 & ciuo08 == "7(2)"  
replace isco08_2d = "75" if caes_2d == 13 & ciuo08 == "7(2)"  
replace isco08_2d = "75" if caes_2d == 14 & ciuo08 == "7(2)"  
replace isco08_2d = "75" if caes_2d == 15 & ciuo08 == "7(2)"  
replace isco08_2d = "75" if caes_2d == 16 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if caes_2d == 17 & ciuo08 == "7(2)"  
replace isco08_2d = "73" if caes_2d == 18 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if caes_2d == 19 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if caes_2d == 20 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if caes_2d == 22 & ciuo08 == "7(2)"  
replace isco08_2d = "73" if caes_2d == 23 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if caes_2d == 24 & ciuo08 == "7(2)"  
replace isco08_2d = "72" if caes_2d == 25 & ciuo08 == "7(2)"  
replace isco08_2d = "75" if caes_2d == 26 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if caes_2d == 27 & ciuo08 == "7(2)"  
replace isco08_2d = "72" if caes_2d == 28 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if caes_2d == 29 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if caes_2d == 30 & ciuo08 == "7(2)"  
replace isco08_2d = "75" if caes_2d == 31 & ciuo08 == "7(2)"  
replace isco08_2d = "79" if caes_2d == 38 & ciuo08 == "7(2)"  

* Caso 8(2)
replace isco08_2d = "81" if caes_2d == 10 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if caes_2d == 12 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if caes_2d == 13 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if caes_2d == 14 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if caes_2d == 15 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if caes_2d == 16 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if caes_2d == 17 & ciuo08 == "8(2)"  
...
replace isco08_2d = "81" if caes_2d == 22 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if caes_2d == 23 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if caes_2d == 24 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if caes_2d == 25 & ciuo08 == "8(2)"  
replace isco08_2d = "82" if caes_2d == 26 & ciuo08 == "8(2)"  
replace isco08_2d = "82" if caes_2d == 27 & ciuo08 == "8(2)"  
replace isco08_2d = "82" if caes_2d == 28 & ciuo08 == "8(2)"  
replace isco08_2d = "89" if caes_2d == 29 & ciuo08 == "8(2)"  
replace isco08_2d = "89" if caes_2d == 30 & ciuo08 == "8(2)"  
replace isco08_2d = "81" if caes_2d == 31 & ciuo08 == "8(2)"  
replace isco08_2d = "89" if caes_2d == 38 & ciuo08 == "8(2)"  
...
*isco08_2d=79
replace isco08_2d = "73" if isco08_2d == "79" & caes_2d == 17 
replace isco08_2d = "75" if isco08_2d == "79" & caes_2d == 19 
replace isco08_2d = "75" if isco08_2d == "79" & caes_2d == 20 
replace isco08_2d = "72" if isco08_2d == "79" & caes_2d == 22 
replace isco08_2d = "72" if isco08_2d == "79" & caes_2d == 24 
replace isco08_2d = "74" if isco08_2d == "79" & caes_2d == 27 
replace isco08_2d = "72" if isco08_2d == "79" & caes_2d == 29 
replace isco08_2d = "72" if isco08_2d == "79" & caes_2d == 30 
replace isco08_2d = "75" if isco08_2d == "79" & caes_2d == 38 
	
*isco08_2d=89
replace isco08_2d = "82" if isco08_2d == "89" & caes_2d == 29 
replace isco08_2d = "82" if isco08_2d == "89" & caes_2d == 30 
replace isco08_2d = "83" if isco08_2d == "89" & caes_2d == 38 

drop cno01 ciuo08 ocup_str caes_2d
format    isco08_2d %2s
...
replace pp06c_hd = 0	if  pp06c_hd<0
replace pp06d_hd = 0	if  pp06d_hd<0
...
replace v18_m_hd = .		if  v18_m_hd>15000
...
gen     lp_extrema = 3595.94		if  trimestre==1 & gba==1   
replace lp_extrema = 3560.39		if  trimestre==1 & pampa==1 
replace lp_extrema = 3196.64		if  trimestre==1 & cuyo==1	
replace lp_extrema = 3112.08		if  trimestre==1 & noa==1	
replace lp_extrema = 3688.92		if  trimestre==1 & pata==1  
replace lp_extrema = 3188.49		if  trimestre==1 & nea==1   
							            
replace	lp_extrema = 3920.32		if  trimestre==2 & gba==1   
replace lp_extrema = 3867.10		if  trimestre==2 & pampa==1 
replace lp_extrema = 3472.49		if  trimestre==2 & cuyo==1	
replace lp_extrema = 3396.72		if  trimestre==2 & noa==1	
replace lp_extrema = 4004.81		if  trimestre==2 & pata==1  
replace lp_extrema = 3471.27		if  trimestre==2 & nea==1   

* Linea de pobreza oficial moderada ("linea de pobreza")
gen     lp_moderada =  8928.19		if  trimestre==1 & gba==1   
replace lp_moderada =  8839.96		if  trimestre==1 & pampa==1 
replace lp_moderada =  8448.32		if  trimestre==1 & cuyo==1
replace lp_moderada =  7177.49		if  trimestre==1 & noa==1
replace lp_moderada = 10413.41		if  trimestre==1 & pata==1  
replace lp_moderada =  7417.52		if  trimestre==1 & nea==1   
						            
replace	lp_moderada =  9814.44		if  trimestre==2 & gba==1   
replace lp_moderada =  9681.23		if  trimestre==2 & pampa==1 
replace lp_moderada =  9272.15		if  trimestre==2 & cuyo==1
replace lp_moderada =  7892.24		if  trimestre==2 & noa==1
replace lp_moderada = 11374.38		if  trimestre==2 & pata==1  
replace lp_moderada =  8146.20		if  trimestre==2 & nea==1   
...
* IPC del mes base
gen ipc = 1605.88037923955994		/*  MES BASE: promedio Diciembre-Mayo	*/

gen cpiperiod = "2020m01-2020m06"

* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.970		if  trimestre==1
replace ipc_rel = 1.030		if  trimestre==2
...
sum contribute_pension ss_healthinsured sp_pi_planempleo sp_pi_pasantia sp_ph_oldagepension sp_ph_unemploymentbenefits sp_ph_subsidiocash sp_ph_subsidioinkind pt_ph_domesticremittancesinkind sp_ph_scholarship pt_ph_domesticremittances sp_mi_oldagepension sp_mi_unemploymentbenefits sp_mi_subsidiocash sp_mi_scholarship pt_mi_domesticremittances m_pensions d_pensions d_activelabor m_passivelabor d_passivelabor m_cashtransfer d_cashtransfer d_inkind d_publicworks m_othersa d_othersa m_domprivate d_domprivate d_interprivate d_interprivate [w=pondera]
