...
replace v18_m_hd = .		if  v18_m_hd>38000
...
gen     lp_extrema = 6099.72		if  trimestre==3 & gba==1   
replace lp_extrema = 6011.62		if  trimestre==3 & pampa==1 
replace lp_extrema = 5388.83		if  trimestre==3 & cuyo==1	
replace lp_extrema = 5298.00		if  trimestre==3 & noa==1	
replace lp_extrema = 6307.29		if  trimestre==3 & pata==1  
replace lp_extrema = 5451.67		if  trimestre==3 & nea==1   
			       				            
replace	lp_extrema = 7008.02		if  trimestre==4 & gba==1   
replace lp_extrema = 6958.73		if  trimestre==4 & pampa==1 
replace lp_extrema = 6226.30		if  trimestre==4 & cuyo==1	
replace lp_extrema = 6089.17		if  trimestre==4 & noa==1	
replace lp_extrema = 7291.59		if  trimestre==4 & pata==1  
replace lp_extrema = 6276.49		if  trimestre==4 & nea==1   

* Linea de pobreza oficial moderada ("linea de pobreza")
gen     lp_moderada = 14802.04		if  trimestre==3 & gba==1   
replace lp_moderada = 14588.29		if  trimestre==3 & pampa==1 
replace lp_moderada = 13939.31		if  trimestre==3 & cuyo==1
replace lp_moderada = 11955.91		if  trimestre==3 & noa==1
replace lp_moderada = 17387.16		if  trimestre==3 & pata==1  
replace lp_moderada = 12411.69		if  trimestre==3 & nea==1   
			        			            
replace	lp_moderada = 16817.12		if  trimestre==4 & gba==1   
replace lp_moderada = 16698.97		if  trimestre==4 & pampa==1 
replace lp_moderada = 15896.08		if  trimestre==4 & cuyo==1
replace lp_moderada = 13557.75		if  trimestre==4 & noa==1
replace lp_moderada = 19855.18		if  trimestre==4 & pata==1  
replace lp_moderada = 14100.19		if  trimestre==4 & nea==1   
...
* IPC del mes base
gen ipc = 1859.60692978832003		/*  MES BASE: promedio Junio-Noviembre	*/ 

gen cpiperiod = "2020m07-2020m12"

* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.951		if  trimestre==3
replace ipc_rel = 1.049		if  trimestre==4
