...
*************************************************************************************************************************************************)*/
* ARG 2016: Personas de 10 y más años de edad
...
notes   sector1d: there are 499 missings observations with ocupado==1 in the variable sector1d
...
notes   sector: there are 499 missings observations with ocupado==1 in the variable sector
...
gen	lp_extrema = 1684.25		if  trimestre==3 & gba==1   
replace lp_extrema = 1508.81		if  trimestre==3 & pampa==1 
replace lp_extrema = 1512.93		if  trimestre==3 & cuyo==1
replace lp_extrema = 1472.08		if  trimestre==3 & noa==1
replace lp_extrema = 1676.16		if  trimestre==3 & pata==1   
replace lp_extrema = 1735.14		if  trimestre==3 & nea==1   		
							            
replace	lp_extrema = 1756.20		if  trimestre==4 & gba==1   
replace lp_extrema = 1570.30		if  trimestre==4 & pampa==1 
replace lp_extrema = 1568.09		if  trimestre==4 & cuyo==1	
replace lp_extrema = 1525.45		if  trimestre==4 & noa==1	
replace lp_extrema = 1746.40		if  trimestre==4 & pata==1   
replace lp_extrema = 1813.35		if  trimestre==4 & nea==1   

* Linea de pobreza oficial moderada("linea de pobreza")
gen	lp_moderada = 4055.15		if  trimestre==3 & gba==1   
replace lp_moderada = 3872.37		if  trimestre==3 & pampa==1 
replace lp_moderada = 3413.95		if  trimestre==3 & cuyo==1
replace lp_moderada = 3292.33		if  trimestre==3 & noa==1
replace lp_moderada = 4033.72		if  trimestre==3 & pata==1         
replace lp_moderada = 4742.32		if  trimestre==3 & nea==1   	
							            
replace	lp_moderada = 4232.45		if  trimestre==4 & gba==1   
replace lp_moderada = 4030.41		if  trimestre==4 & pampa==1 
replace lp_moderada = 3538.65		if  trimestre==4 & cuyo==1 
replace lp_moderada = 3411.90		if  trimestre==4 & noa==1
replace lp_moderada = 4208.81		if  trimestre==4 & pata==1  
replace lp_moderada = 4962.51		if  trimestre==4 & nea==1   
...
* IPC del mes base
gen ipc = 505.615127563476	/*  MES BASE: promedio Julio-Diciembre	*/

gen cpiperiod = "2016m07-2016m12"
