...
notes   sector1d: there are 492 missings observations with ocupado==1 in the variable sector1d
...
notes   sector: there are 492 missings observations with ocupado==1 in the variable sector
...
replace v18_m_hd = .		if  v18_m_hd>21000
...
gen     lp_extrema = 2018.67		if  trimestre==3 & gba==1   
replace lp_extrema = 1801.53		if  trimestre==3 & pampa==1 
replace lp_extrema = 1793.25		if  trimestre==3 & cuyo==1	
replace lp_extrema = 1752.61		if  trimestre==3 & noa==1	
replace lp_extrema = 2003.65		if  trimestre==3 & pata==1   
replace lp_extrema = 2070.33		if  trimestre==3 & nea==1   
							            
replace	lp_extrema = 2118.45		if  trimestre==4 & gba==1   
replace lp_extrema = 1893.92		if  trimestre==4 & pampa==1 
replace lp_extrema = 1888.47		if  trimestre==4 & cuyo==1	
replace lp_extrema = 1845.27		if  trimestre==4 & noa==1	
replace lp_extrema = 2109.91		if  trimestre==4 & pata==1   
replace lp_extrema = 2183.87		if  trimestre==4 & nea==1   

* Linea de pobreza oficial moderada ("linea de pobreza")
gen     lp_moderada = 4932.17		if  trimestre==3 & gba==1   
replace lp_moderada = 4689.87		if  trimestre==3 & pampa==1 
replace lp_moderada = 4106.43		if  trimestre==3 & cuyo==1 
replace lp_moderada = 3978.30		if  trimestre==3 & noa==1
replace lp_moderada = 4895.47		if  trimestre==3 & pata==1  
replace lp_moderada = 5741.60		if  trimestre==3 & nea==1   
							            
replace	lp_moderada = 5219.20		if  trimestre==4 & gba==1   
replace lp_moderada = 4975.42		if  trimestre==4 & pampa==1 
replace lp_moderada = 4362.94		if  trimestre==4 & cuyo==1 
replace lp_moderada = 4226.11		if  trimestre==4 & noa==1
replace lp_moderada = 5198.14		if  trimestre==4 & pata==1  
replace lp_moderada = 6108.55		if  trimestre==4 & nea==1   
...
* IPC del mes base
gen ipc = 621.960099221008	/*  MES BASE: promedio Julio-Diciembre	*/
