...
replace v18_m_hd = .	if  v18_m_hd>2000
...
gen	lp_extrema =     .	
replace lp_extrema =  118.16		if  trimestre==3 		
replace lp_extrema =  118.94		if  trimestre==4 		
...
gen	lp_moderada =     .
replace lp_moderada =  314.52		if  trimestre==3 
replace lp_moderada =  317.57		if  trimestre==4   
...
* IPC del mes base
gen ipc = 39.4404570261637			/*  MES BASE: promedio Junio-Noviembre	*/

gen cpiperiod = "2004m07-2004m12"
    
* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.994		if  trimestre==3
replace ipc_rel = 1.006		if  trimestre==4
