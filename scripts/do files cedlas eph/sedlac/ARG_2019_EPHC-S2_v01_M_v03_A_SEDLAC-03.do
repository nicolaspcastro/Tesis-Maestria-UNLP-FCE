...
*************************************************************************************************************************************************)*/
* ARG 2019: Personas de 10 y más años de edad
...
gen     lp_extrema = 4309.17		if  trimestre==3 & gba==1   
replace lp_extrema = 4256.20		if  trimestre==3 & pampa==1 
replace lp_extrema = 3831.79		if  trimestre==3 & cuyo==1	
replace lp_extrema = 3751.76		if  trimestre==3 & noa==1	
replace lp_extrema = 4461.78		if  trimestre==3 & pata==1  
replace lp_extrema = 3852.99		if  trimestre==3 & nea==1   
			       				            
replace	lp_extrema = 4841.98		if  trimestre==4 & gba==1   
replace lp_extrema = 4803.07		if  trimestre==4 & pampa==1 
replace lp_extrema = 4326.84		if  trimestre==4 & cuyo==1	
replace lp_extrema = 4233.95		if  trimestre==4 & noa==1	
replace lp_extrema = 5037.27		if  trimestre==4 & pata==1  
replace lp_extrema = 4349.90		if  trimestre==4 & nea==1   

* Linea de pobreza oficial moderada ("linea de pobreza")
gen     lp_moderada = 10758.62		if  trimestre==3 & gba==1   
replace lp_moderada = 10626.39		if  trimestre==3 & pampa==1 
replace lp_moderada = 10179.85		if  trimestre==3 & cuyo==1
replace lp_moderada =  8691.63		if  trimestre==3 & noa==1
replace lp_moderada = 12656.66		if  trimestre==3 & pata==1  
replace lp_moderada =  9003.21		if  trimestre==3 & nea==1   
			        			            
replace	lp_moderada = 12103.99		if  trimestre==4 & gba==1   
replace lp_moderada = 11990.52		if  trimestre==4 & pampa==1 
replace lp_moderada = 11499.72		if  trimestre==4 & cuyo==1
replace lp_moderada =  9821.87		if  trimestre==4 & noa==1
replace lp_moderada = 14287.89		if  trimestre==4 & pata==1  
replace lp_moderada = 10177.86		if  trimestre==4 & nea==1   
...
* IPC del mes base
gen ipc = 1347.69230876404		/*  MES BASE: promedio Junio-Noviembre	*/

gen cpiperiod = "2019m07-2019m12"

* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.938		if  trimestre==3
replace ipc_rel = 1.062		if  trimestre==4
