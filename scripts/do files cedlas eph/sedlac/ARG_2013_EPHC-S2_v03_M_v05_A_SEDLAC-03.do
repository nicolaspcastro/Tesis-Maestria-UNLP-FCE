...
local year     	"2013"   	// Year of the survey
...
*************************************************************************************************************************************************)*/
* ARG 2013: Personas de 10 y más años de edad
...
replace sector1d = 5		if (rama>=35 & rama<=36) | (rama>=3501 &  rama<=3604)
...
replace sector1d = 12		if (rama>=83 & rama<=84) | (rama>=8300 & rama<=8407)
...
replace sector1d = 15		if (rama>=37 & rama<=39) | (rama>=59 & rama<=60) | rama==63 | (rama>=90 & rama<=94) | rama==96 | ///
                                   (rama>=3700 & rama<=3900) | (rama>=5900 & rama<=6000) | rama==6300 | (rama>=9000 & rama<=9409) | (rama>=9600 & rama<=9609)
...
notes   sector1d: there are 217 missings observations with ocupado==1 in the variable sector1d
...
notes   sector: there are 217 missings observations with ocupado==1 in the variable sector
...
gen	lp_extrema =     .	
replace lp_extrema =  702.28		if  trimestre==3 		
replace lp_extrema =  777.67		if  trimestre==4 		
...
gen	lp_moderada =     .
replace lp_moderada = 1593.16		if  trimestre==3   
replace lp_moderada = 1699.00		if  trimestre==4  
...
* IPC del mes base
gen ipc = 203.222335815429	/*  MES BASE: promedio Julio-Diciembre	*/

gen cpiperiod = "2013m07-2013m12"
 
* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.971		if  trimestre==3
replace ipc_rel = 1.029		if  trimestre==4
