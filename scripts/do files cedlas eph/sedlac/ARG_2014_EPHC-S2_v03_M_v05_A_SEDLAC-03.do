...
*************************************************************************************************************************************************)*/
* ARG 2014: Personas de 10 y más años de edad
...
gen	    lp_extrema =     .	
replace lp_extrema = 1016.24		if  trimestre==3 	
replace lp_extrema = 1066.03		if  trimestre==4 	
...
gen	    lp_moderada =     .
replace lp_moderada = 2248.27		if  trimestre==3   
replace lp_moderada = 2388.41		if  trimestre==4   
...
* IPC del mes base
gen ipc = 285.221165974935	/*  MES BASE: promedio Junio-Noviembre	*/

gen cpiperiod = "2014m07-2014m12"
 
* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.966		if  trimestre==3
replace ipc_rel = 1.034		if  trimestre==4
