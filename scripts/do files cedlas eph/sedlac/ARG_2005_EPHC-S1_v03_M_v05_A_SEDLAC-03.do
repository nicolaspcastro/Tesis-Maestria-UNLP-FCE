...
local year     	"2005"   	// Year of the survey
...
*************************************************************************************************************************************************)*/
* ARG 2005: Personas de 10 y más años de edad
...
replace v18_m_hd = .	if  v18_m_hd>3800
...
gen	lp_extrema =     .	
replace lp_extrema =  122.61		if  trimestre==1 		
replace lp_extrema =  125.53		if  trimestre==2 		
...
gen	lp_moderada =     .
replace lp_moderada =  327.33		if  trimestre==1  
replace lp_moderada =  333.65		if  trimestre==2   
...
* IPC del mes base
gen ipc = 41.4811668395996			/*  MES BASE: promedio Diciembre-Mayo	*/

gen cpiperiod = "2005m01-2005m06"
   
* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.984		if  trimestre==1
replace ipc_rel = 1.016		if  trimestre==2
