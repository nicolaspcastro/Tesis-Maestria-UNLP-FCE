...
*eplace sanitation_source =  5	if					                /* Ventilated improved pit latrine (VIP) IMP */
*eplace sanitation_source =  6	if					                /* Pit latrine with slab		 IMP	     */
*eplace sanitation_source =  7	if					                /* Composting toilet		         IMP     */
*eplace sanitation_source =  8	if					                /* Special case					             */
...
*eplace sanitation_source = 11	if					                /* Bucket					                 */
*eplace sanitation_source = 12	if					                /* Hanging toilet or hanging latrine	     */
replace sanitation_source = 13	if  iv8==2				            /* No facilities or bush or field		     */
*eplace sanitation_source = 14	if					                 /* Other					                 */
...
*eplace toilet_acc = 3		    if				/* Yes, unestated whether in or outside premises*/
...
*************************************************************************************************************************************************)*/
* ARG 2015: Personas de 10 y más años de edad
...
replace sector1d = 11		if  rama==62 | (rama>=68 &  rama<=74)  | (rama>=77 & rama<=78) | (rama>=80 & rama<=82) | rama==6200 |  ///
                                   (rama>=6800 & rama<=7401) | (rama>=7701 & rama<=7800) | (rama>=8000 & rama<=8101) | rama==8200 | rama==9501
...
notes   sector1d: there are 196 missings observations with ocupado==1 in the variable sector1d
...
notes   sector: there are 196 missings observations with ocupado==1 in the variable sector
...
replace v18_m_hd = .	if  v18_m_hd>8000
...
gen	    lp_extrema =     .	
replace lp_extrema = 1106.20		if  trimestre==1 
replace lp_extrema = 1148.23		if  trimestre==2 	
...
gen	    lp_moderada =     .
replace lp_moderada = 2517.72		if  trimestre==1 
replace lp_moderada = 2663.75		if  trimestre==2  
...
* IPC del mes base
gen ipc = 318.17984008789	/*  MES BASE: promedio Diciembre-Mayo	*/

gen cpiperiod = "2015m01-2015m06"

* Factor de ajuste para cada observación
gen     ipc_rel = 1.000
replace ipc_rel = 0.973		if  trimestre==1
replace ipc_rel = 1.027		if  trimestre==2
