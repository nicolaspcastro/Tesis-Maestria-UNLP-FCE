...
/* From 06/2020 to 08/2020
   AUH/Embarazo:
      $  3293 (General) - $  4281 (ZONA 1)
   Hijo con Discapacidad: 
      $ 10730 (General) - $ 13949 (ZONA 1)

   From 09/2020 to 11/2020
   AUH/Embarazo:
      $  3540 (General) - $  4602 (ZONA 1)
   Hijo con Discapacidad: 
      $ 11535 (General) - $ 14996 (ZONA 1)						*/
...
gen       sp_mi_auh = 0
replace   sp_mi_auh = v5_m_hd	if  trimestre==1 & zona1==1 & ((v5_m_hd>=3250 & v5_m_hd<=3600) | (v5_m_hd>=6600 & v5_m_hd<=7000) | (v5_m_hd>=10000 & v5_m_hd<=10500) | (v5_m_hd>=13500 & v5_m_hd<=14000) | (v5_m_hd>=17000 & v5_m_hd<=17500) | (v5_m_hd>=10500 & v5_m_hd<=11500))
replace   sp_mi_auh = v5_m_hd	if  trimestre==1 & zona0==1 & ((v5_m_hd>=2500 & v5_m_hd<=2800) | (v5_m_hd>=5100 & v5_m_hd<=5500) |  (v5_m_hd>=7800 & v5_m_hd<=8200)  | (v5_m_hd>=10350 & v5_m_hd<=10750) | (v5_m_hd>=13000 & v5_m_hd<=13500) |  (v5_m_hd>=8000 & v5_m_hd<=9000))

replace   sp_mi_auh = v5_m_hd	if  trimestre==2 & zona1==1 & ((v5_m_hd>=3500 & v5_m_hd<=3900) | (v5_m_hd>=7100 & v5_m_hd<=7600) | (v5_m_hd>=10900 & v5_m_hd<=11200) | (v5_m_hd>=14500 & v5_m_hd<=15000) | (v5_m_hd>=18200 & v5_m_hd<=18600) | (v5_m_hd>=11500 & v5_m_hd<=12500))
replace   sp_mi_auh = v5_m_hd	if  trimestre==2 & zona0==1 & ((v5_m_hd>=2650 & v5_m_hd<=2950) | (v5_m_hd>=5450 & v5_m_hd<=5850) |  (v5_m_hd>=8300 & v5_m_hd<=8700)  | (v5_m_hd>=11100 & v5_m_hd<=11600) | (v5_m_hd>=14000 & v5_m_hd<=14500) |  (v5_m_hd>=9000 & v5_m_hd<=10000))
