...
** INPUT DATABASES:             ARG_2020_EPHC-S1_v01_M_v01_A_SEDLAC-03_ALL.dta
**                              ARG_2020_EPHC-S1_v01_M_v01_A_SEDLAC-03_GMD.dta
...
/* From 12/2019 to 02/2020
   AUH/Embarazo:
      $ 2746 (General)  - $  3570 (ZONA 1)
   Hijo con Discapacidad: 
      $ 8947 (General)  - $ 11632 (ZONA 1)

   From 03/2020 to 05/2020
   AUH/Embarazo:
      $  3103 (General) - $  4035 (ZONA 1)
   Hijo con Discapacidad: 
      $ 10111 (General) - $ 13145 (ZONA 1)						*/
...
gen       sp_mi_auh = 0
replace   sp_mi_auh = v5_m_hd              if  v5_m_hd>=2200 & v5_m_hd<=12500
...
/*
gen       sp_mi_auh = 0
replace   sp_mi_auh = v5_m_hd	if  trimestre==1 & zona1==1 & ((v5_m_hd>=2700 & v5_m_hd<=3000) | (v5_m_hd>=5500 & v5_m_hd<=5900) | (v5_m_hd>=8350 & v5_m_hd<=8750) | (v5_m_hd>=11200 & v5_m_hd<=11600) | (v5_m_hd>=14000 & v5_m_hd<=14500) | (v5_m_hd>=9000 & v5_m_hd<=9500))
replace   sp_mi_auh = v5_m_hd	if  trimestre==1 & zona0==1 & ((v5_m_hd>=2050 & v5_m_hd<=2350) | (v5_m_hd>=4200 & v5_m_hd<=4600) | (v5_m_hd>=6350 & v5_m_hd<=6750) |  (v5_m_hd>=8500 & v5_m_hd<=9000)  | (v5_m_hd>=10700 & v5_m_hd<=11300) | (v5_m_hd>=7000 & v5_m_hd<=7500))

replace   sp_mi_auh = v5_m_hd	if  trimestre==2 & zona1==1 & ((v5_m_hd>=3000 & v5_m_hd<=3400) | (v5_m_hd>=6250 & v5_m_hd<=6650) | (v5_m_hd>=8100 & v5_m_hd<=8450) | (v5_m_hd>=12700 & v5_m_hd<=13200) | (v5_m_hd>=15900 & v5_m_hd<=16500) | (v5_m_hd>=10000 & v5_m_hd<=11000))
replace   sp_mi_auh = v5_m_hd	if  trimestre==2 & zona0==1 & ((v5_m_hd>=2350 & v5_m_hd<=2650) | (v5_m_hd>=4800 & v5_m_hd<=5200) | (v5_m_hd>=9450 & v5_m_hd<=9950) |  (v5_m_hd>=9700 & v5_m_hd<=10200) | (v5_m_hd>=12200 & v5_m_hd<=12600) |  (v5_m_hd>=7700 & v5_m_hd<=8300))
