...
** INPUT DATABASES:             ARG_2018_EPHC-S2_v01_M_v01_A_SEDLAC-03_ALL.dta
**                              ARG_2018_EPHC-S2_v01_M_v01_A_SEDLAC-03_GMD.dta
** RESPONSIBLE:                 Leopoldo Tornarolli
** CREATED:                     01/04/2020
** NUMBER OF HOUSEHOLDS:         36,938 
** NUMBER OF INDIVIDUALS:       114,297
**                                                                                                 
******************************************************************************************************
******************************************************************************************************/
...
datalibweb, country(ARG) year(2018) type(GMD) vermast(01) veralt(01) survey(EPHC) module(ALL) clear
isid hhid pid
...
/* From 06/2018 to 08/2018
   AUH/Embarazo:
      $ 1578 (General) - $ 2052 (ZONA 1)
   Hijo con Discapacidad: 
      $ 5147 (General) - $ 6692 (ZONA 1)

   From 09/2018 to 11/2018
   AUH/Embarazo:
      $ 1684 (General) - $ 2190 (ZONA 1)
   Hijo con Discapacidad: 
      $ 5491 (General) - $ 7139 (ZONA 1)						*/
...
gen       sp_mi_auh = 0
replace   sp_mi_auh = v5_m_hd              if  v5_m_hd>=1200 & v5_m_hd<=7100
...
/*
gen       sp_mi_auh = 0
replace   sp_mi_auh = v5_m_hd	if  trimestre==3 & zona1==1 & ((v5_m_hd>=1400 & v5_m_hd<=1500) | (v5_m_hd>=2800 & v5_m_hd<=3000) | (v5_m_hd>=4200 & v5_m_hd<=4500) | (v5_m_hd>=5600 & v5_m_hd<=6000) | (v5_m_hd>=7000 & v5_m_hd<=7450) | (v5_m_hd>=4700 & v5_m_hd<=4850))
replace   sp_mi_auh = v5_m_hd	if  trimestre==3 & zona0==1 & ((v5_m_hd>=1100 & v5_m_hd<=1200) | (v5_m_hd>=2200 & v5_m_hd<=2400) | (v5_m_hd>=3300 & v5_m_hd<=3600) | (v5_m_hd>=4400 & v5_m_hd<=4800) | (v5_m_hd>=5500 & v5_m_hd<=6000) | (v5_m_hd>=3600 & v5_m_hd<=3800))

replace   sp_mi_auh = v5_m_hd	if  trimestre==4 & zona1==1 & ((v5_m_hd>=1500 & v5_m_hd<=1600) | (v5_m_hd>=3000 & v5_m_hd<=3200) | (v5_m_hd>=4500 & v5_m_hd<=4800) | (v5_m_hd>=6000 & v5_m_hd<=6400) | (v5_m_hd>=7500 & v5_m_hd<=8000) | (v5_m_hd>=4900 & v5_m_hd<=5100))
replace   sp_mi_auh = v5_m_hd	if  trimestre==4 & zona0==1 & ((v5_m_hd>=1100 & v5_m_hd<=1200) | (v5_m_hd>=2300 & v5_m_hd<=2500) | (v5_m_hd>=3300 & v5_m_hd<=3600) | (v5_m_hd>=4500 & v5_m_hd<=4900) | (v5_m_hd>=5600 & v5_m_hd<=6100) | (v5_m_hd>=3800 & v5_m_hd<=4000))
