...
** INPUT DATABASES:             ARG_2018_EPHC-S2_v01_M_v04_A_SEDLAC-03_ALL.dta
**                              ARG_2018_EPHC-S2_v01_M_v04_A_SEDLAC-03_GMD.dta
...
datalibweb, country(ARG) year(2018) type(GMD) vermast(01) veralt(04) survey(EPHC) module(ALL) clear
isid hhid pid
...
dlw, coun(`code') y(`year') sur(`survey') t(SEDLAC-03) mod(ALL) verm(01) vera(04)  
