...
** INPUT DATABASES:             ARG_2018_EPHC-S1_v02_M_v01_A_SEDLAC-03_ALL.dta
**                              ARG_2018_EPHC-S1_v02_M_v01_A_SEDLAC-03_GMD.dta
** RESPONSIBLE:                 Leopoldo Tornarolli
** CREATED:                     01/04/2020
** NUMBER OF HOUSEHOLDS:         37,175 
** NUMBER OF INDIVIDUALS:       115,786
**                                                                                                 
******************************************************************************************************
******************************************************************************************************/
...
gl baseo "S:\1- RAW DATA\LAC\Argentina\2018\Data"
cd       "S:\2- HARMONIZED DATA\Do and Ini Files for ADePT\LAC\Argentina\2018\2- Do, ini and dta files - Program Specific"
...
datalibweb, country(ARG) year(2018) type(GMD) vermast(02) veralt(01) survey(EPHC) module(ALL) clear
isid hhid pid
...
dlw, coun(`code') y(`year') sur(`survey') t(SEDLAC-03) mod(ALL) verm(02) vera(01)  
...
* Asignación Universal por Hijo (AUH) - Se cobra el 80% de los montos mencionados abajo
/* From 09/2017 to 02/2018
   AUH/Embarazo:
      $ 1412 (General) - $ 1836 (ZONA 1)
   Hijo con Discapacidad: 
      $ 4606 (General) - $ 5988 (ZONA 1)

   From 03/2018 to 05/2018
   AUH/Embarazo:
      $ 1493 (General) - $ 1941 (ZONA 1)
   Hijo con Discapacidad: 
      $ 4869 (General) - $ 6330 (ZONA 1)						*/
gen zona1 = 1		if  aglo==30 | aglo==9 | aglo==17 | aglo==91 | aglo==93 | aglo==20 | aglo==31
gen zona0 = 1		if  aglo!=30 & aglo!=9 & aglo!=17 & aglo!=91 & aglo!=93 & aglo!=20 & aglo!=31

gen       sp_mi_auh = 0
replace   sp_mi_auh = v5_m_hd              if  v5_m_hd>=1100 & v5_m_hd<=6500
...
/*
gen       sp_mi_auh = 0
replace   sp_mi_auh = v5_m_hd	if  trimestre==1 & zona1==1 & ((v5_m_hd>=1400 & v5_m_hd<=1500) | (v5_m_hd>=2800 & v5_m_hd<=3000) | (v5_m_hd>=4200 & v5_m_hd<=4500) | (v5_m_hd>=5600 & v5_m_hd<=6000) | (v5_m_hd>=7000 & v5_m_hd<=7450) | (v5_m_hd>=4700 & v5_m_hd<=4850))
replace   sp_mi_auh = v5_m_hd	if  trimestre==1 & zona0==1 & ((v5_m_hd>=1100 & v5_m_hd<=1200) | (v5_m_hd>=2200 & v5_m_hd<=2400) | (v5_m_hd>=3300 & v5_m_hd<=3600) | (v5_m_hd>=4400 & v5_m_hd<=4800) | (v5_m_hd>=5500 & v5_m_hd<=6000) | (v5_m_hd>=3600 & v5_m_hd<=3800))

replace   sp_mi_auh = v5_m_hd	if  trimestre==2 & zona1==1 & ((v5_m_hd>=1500 & v5_m_hd<=1600) | (v5_m_hd>=3000 & v5_m_hd<=3200) | (v5_m_hd>=4500 & v5_m_hd<=4800) | (v5_m_hd>=6000 & v5_m_hd<=6400) | (v5_m_hd>=7500 & v5_m_hd<=8000) | (v5_m_hd>=4900 & v5_m_hd<=5100))
replace   sp_mi_auh = v5_m_hd	if  trimestre==2 & zona0==1 & ((v5_m_hd>=1100 & v5_m_hd<=1200) | (v5_m_hd>=2300 & v5_m_hd<=2500) | (v5_m_hd>=3300 & v5_m_hd<=3600) | (v5_m_hd>=4500 & v5_m_hd<=4900) | (v5_m_hd>=5600 & v5_m_hd<=6100) | (v5_m_hd>=3800 & v5_m_hd<=4000))
replace   sp_mi_auh = .		if  sp_mi_auh==0
label var sp_mi_auh "Asignacion Universal por Hijo - monthly in LCU (ind)"
drop zona*
*/
