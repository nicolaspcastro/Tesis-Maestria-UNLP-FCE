...
*                               REGRESIONES
				local hogar     "miembros jedad maxedu jefe_ocu jhombre tipo_hogar_2 tipo_hogar_3"	
...
* LP
local ipc05 = 42.5875282287597656
local ppp05 =  1.353
...
cuantiles ipcf_sin_ri [w=pondera], n(10) orden_aux(id com relacion edad) gen(d_ipcf)
