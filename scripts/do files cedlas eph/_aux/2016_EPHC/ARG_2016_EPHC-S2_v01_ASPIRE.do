...
** INPUT DATABASES:             ARG_2016_EPHC-S2_v02_M_v01_A_SEDLAC-03_ALL.dta
**                              ARG_2016_EPHC-S2_v02_M_v01_A_SEDLAC-03_GMD.dta
** RESPONSIBLE:                 Leopoldo Tornarolli
** CREATED:                     01/04/2020
** NUMBER OF HOUSEHOLDS:         37,123
** NUMBER OF INDIVIDUALS:       117,704
**                                                                                                 
******************************************************************************************************
******************************************************************************************************/
...
gl baseo "S:\1- RAW DATA\LAC\Argentina\2016\Data"
cd       "S:\2- HARMONIZED DATA\Do and Ini Files for ADePT\LAC\Argentina\2016\2- Do, ini and dta files - Program Specific"
...
datalibweb, country(ARG) year(2016) type(GMD) vermast(02) veralt(01) survey(EPHC) module(ALL) clear
isid hhid pid
...
/* From 03/2016 to 08/2016
   AUH/Embarazo:
      $  966 (General) - $ 1256 (ZONA 1)
   Hijo con Discapacidad: 
      $ 3150 (General) - $ 4095 (ZONA 1)
...
gen       sp_mi_auh = 0
replace   sp_mi_auh = v5_m_hd              if  v5_m_hd>=750 & v5_m_hd<=4500
