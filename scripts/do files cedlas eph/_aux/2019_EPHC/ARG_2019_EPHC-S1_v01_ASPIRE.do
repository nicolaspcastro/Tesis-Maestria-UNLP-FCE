...
replace   sp_mi_auh = v5_m_hd	if  trimestre==2 & zona1==1 & ((v5_m_hd>=2650 & v5_m_hd<=2850) | (v5_m_hd>=5350 & v5_m_hd<=5650) | (v5_m_hd>=8100 & v5_m_hd<=8450) | (v5_m_hd>=10800 & v5_m_hd<=11300) | (v5_m_hd>=13000 & v5_m_hd<=14000) | (v5_m_hd>=8800 & v5_m_hd<=9250))
replace   sp_mi_auh = v5_m_hd	if  trimestre==2 & zona0==1 & ((v5_m_hd>=2000 & v5_m_hd<=2250) | (v5_m_hd>=4100 & v5_m_hd<=4350) | (v5_m_hd>=6000 & v5_m_hd<=6650) |  (v5_m_hd>=8000 & v5_m_hd<=8600)  | (v5_m_hd>=10000 & v5_m_hd<=10800) | (v5_m_hd>=6700 & v5_m_hd<=7100))
