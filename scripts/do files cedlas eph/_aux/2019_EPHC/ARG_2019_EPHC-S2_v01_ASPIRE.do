...
** INPUT DATABASES:             ARG_2019_EPHC-S2_v01_M_v01_A_SEDLAC-03_ALL.dta
**                              ARG_2019_EPHC-S2_v01_M_v01_A_SEDLAC-03_GMD.dta
...
/* From 06/2019 to 08/2019
   ...
   From 09/2019 to 11/2019
   AUH/Embarazo:
      $ 2652 (General) - $  3448 (ZONA 1)
   Hijo con Discapacidad: 
      $ 8642 (General) - $ 11235 (ZONA 1)						*/
...
gen       sp_mi_auh = 0
replace   sp_mi_auh = v5_m_hd              if  v5_m_hd>=2100 & v5_m_hd<=11000
...
/*
gen       sp_mi_auh = 0
replace   sp_mi_auh = v5_m_hd	if  trimestre==3 & zona1==1 & ((v5_m_hd>=2650 & v5_m_hd<=2850) | (v5_m_hd>=5350 & v5_m_hd<=5650) | (v5_m_hd>=8100 & v5_m_hd<=8450) | (v5_m_hd>=10800 & v5_m_hd<=11300) | (v5_m_hd>=13000 & v5_m_hd<=14000) | (v5_m_hd>=6500 & v5_m_hd<=7200))
replace   sp_mi_auh = v5_m_hd	if  trimestre==3 & zona0==1 & ((v5_m_hd>=2000 & v5_m_hd<=2250) | (v5_m_hd>=4100 & v5_m_hd<=4350) | (v5_m_hd>=6000 & v5_m_hd<=6650) |  (v5_m_hd>=8000 & v5_m_hd<=8600)  | (v5_m_hd>=10200 & v5_m_hd<=11000) | (v5_m_hd>=5000 & v5_m_hd<=5500))

replace   sp_mi_auh = v5_m_hd	if  trimestre==4 & zona1==1 & ((v5_m_hd>=2650 & v5_m_hd<=2850) | (v5_m_hd>=5350 & v5_m_hd<=5650) | (v5_m_hd>=8100 & v5_m_hd<=8450) | (v5_m_hd>=10800 & v5_m_hd<=11300) | (v5_m_hd>=13000 & v5_m_hd<=14000) | (v5_m_hd>=8700 & v5_m_hd<=9300))
replace   sp_mi_auh = v5_m_hd	if  trimestre==4 & zona0==1 & ((v5_m_hd>=2000 & v5_m_hd<=2250) | (v5_m_hd>=4100 & v5_m_hd<=4350) | (v5_m_hd>=6000 & v5_m_hd<=6650) |  (v5_m_hd>=8000 & v5_m_hd<=8600)  | (v5_m_hd>=10200 & v5_m_hd<=11000) | (v5_m_hd>=6700 & v5_m_hd<=7200))
