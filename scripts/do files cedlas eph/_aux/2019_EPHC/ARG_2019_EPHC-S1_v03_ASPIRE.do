...
** INPUT DATABASES:             ARG_2019_EPHC-S1_v01_M_v03_A_SEDLAC-03_ALL.dta
**                              ARG_2019_EPHC-S1_v01_M_v03_A_SEDLAC-03_GMD.dta
...
datalibweb, country(ARG) year(2019) type(GMD) vermast(01) veralt(03) survey(EPHC) module(ALL) clear
isid hhid pid
...
dlw, coun(`code') y(`year') sur(`survey') t(SEDLAC-03) mod(ALL) verm(01) vera(03)  
