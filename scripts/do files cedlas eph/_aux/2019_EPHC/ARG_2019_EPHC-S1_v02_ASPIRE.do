...
** INPUT DATABASES:             ARG_2019_EPHC-S1_v01_M_v01_A_SEDLAC-03_ALL.dta
**                              ARG_2019_EPHC-S1_v01_M_v01_A_SEDLAC-03_GMD.dta
** RESPONSIBLE:                 Leopoldo Tornarolli
** CREATED:                     01/04/2020
** NUMBER OF HOUSEHOLDS:         38,588 
** NUMBER OF INDIVIDUALS:       118,627
**                                                                                                 
******************************************************************************************************
******************************************************************************************************/
...
gl baseo "S:\1- RAW DATA\LAC\Argentina\2019\Data"
cd       "S:\2- HARMONIZED DATA\Do and Ini Files for ADePT\LAC\Argentina\2019\2- Do, ini and dta files - Program Specific"
...
datalibweb, country(ARG) year(2019) type(GMD) vermast(01) veralt(01) survey(EPHC) module(ALL) clear
isid hhid pid
...
/* From 12/2018 to 02/2019
   AUH/Embarazo:
      $ 1816 (General) - $ 2361 (ZONA 1)
   Hijo con Discapacidad: 
      $ 5919 (General) - $ 7695 (ZONA 1)

   From 03/2019 to 05/2019
   AUH/Embarazo:
      $ 2652 (General) - $ 3448 (ZONA 1)
   Hijo con Discapacidad: 
      $ 6620 (General) - $ 8606 (ZONA 1)						*/
...
gen       sp_mi_auh = 0
replace   sp_mi_auh = v5_m_hd              if  v5_m_hd>=1400 & v5_m_hd<=7600
...
/*
gen       sp_mi_auh = 0
replace   sp_mi_auh = v5_m_hd	if  trimestre==1 & zona1==1 & ((v5_m_hd>=1750 & v5_m_hd<=1950) | (v5_m_hd>=3650 & v5_m_hd<=3950) | (v5_m_hd>=5400 & v5_m_hd<=5850) | (v5_m_hd>=7300 & v5_m_hd<=7800) | (v5_m_hd>=9000 & v5_m_hd<=9700) | (v5_m_hd>=6000 & v5_m_hd<=6400))
replace   sp_mi_auh = v5_m_hd	if  trimestre==1 & zona0==1 & ((v5_m_hd>=1350 & v5_m_hd<=1550) | (v5_m_hd>=2750 & v5_m_hd<=3050) | (v5_m_hd>=4100 & v5_m_hd<=4500) | (v5_m_hd>=5500 & v5_m_hd<=6000) | (v5_m_hd>=7000 & v5_m_hd<=7500) | (v5_m_hd>=4600 & v5_m_hd<=4950))

replace   sp_mi_auh = v5_m_hd	if  trimestre==2 & zona1==1 & ((v5_m_hd>=2650 & v5_m_hd<=2850) | (v5_m_hd>=5350 & v5_m_hd<=5650) | (v5_m_hd>=8100 & v5_m_hd<=8450) | (v5_m_hd>=10800 & v5_m_hd<=11300) | (v5_m_hd>=13000 & v5_m_hd<=14000) | (v5_m_hd>=6500 & v5_m_hd<=7200))
replace   sp_mi_auh = v5_m_hd	if  trimestre==2 & zona0==1 & ((v5_m_hd>=2000 & v5_m_hd<=2250) | (v5_m_hd>=4100 & v5_m_hd<=4350) | (v5_m_hd>=6000 & v5_m_hd<=6650) |  (v5_m_hd>=8000 & v5_m_hd<=8600)  | (v5_m_hd>=10200 & v5_m_hd<=11000) | (v5_m_hd>=5000 & v5_m_hd<=5500))
