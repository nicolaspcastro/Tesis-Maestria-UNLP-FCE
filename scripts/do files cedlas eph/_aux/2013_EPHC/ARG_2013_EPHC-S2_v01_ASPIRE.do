...
** INPUT DATABASES:             arg_2013_ephc-s2_v01_m_v01_a_sedlac-03_all.dta
**                              arg_2013_ephc-s2_v01_m_v01_a_sedlac-03_gmd.dta
** RESPONSIBLE:                 Leopoldo Tornarolli
** CREATED:                     12/10/2019
** NUMBER OF HOUSEHOLDS:         34,810
** NUMBER OF INDIVIDUALS:       112,074
**                                                                                                 
******************************************************************************************************
******************************************************************************************************/
...
gen       sp_mi_auh = 0
replace   sp_mi_auh = v5_m              if  v5_m>=350 & v5_m<=1850
