...
** INPUT DATABASES:             ARG_2017_EPHC-S1_v02_M_v01_A_SEDLAC-03_ALL.dta
**                              ARG_2017_EPHC-S1_v02_M_v01_A_SEDLAC-03_GMD.dta
** RESPONSIBLE:                 Leopoldo Tornarolli
** CREATED:                     01/04/2020
** NUMBER OF HOUSEHOLDS:         37,307
** NUMBER OF INDIVIDUALS:       118,430
**                                                                                                 
******************************************************************************************************
******************************************************************************************************/
...
gl baseo "S:\1- RAW DATA\LAC\Argentina\2017\Data"
cd       "S:\2- HARMONIZED DATA\Do and Ini Files for ADePT\LAC\Argentina\2017\2- Do, ini and dta files - Program Specific"
...
datalibweb, country(ARG) year(2017) type(GMD) vermast(02) veralt(01) survey(EPHC) module(ALL) clear
isid hhid pid
...
/* From 09/2017 to 02/2018
   AUH/Embarazo:
      $ 1103 (General) - $ 1434 (ZONA 1)
   Hijo con Discapacidad: 
      $ 3597 (General) - $ 4677 (ZONA 1)

   From 03/2018 to 05/2018
   AUH/Embarazo:
      $ 1246 (General) - $ 1620 (ZONA 1)
   Hijo con Discapacidad: 
      $ 4064 (General) - $ 5284 (ZONA 1)						*/
...
gen       sp_mi_auh = 0
replace   sp_mi_auh = v5_m_hd              if  v5_m_hd>=850 & v5_m_hd<=5000
