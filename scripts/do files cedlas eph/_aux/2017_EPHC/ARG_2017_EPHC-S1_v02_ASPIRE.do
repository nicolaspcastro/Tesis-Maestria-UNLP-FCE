...
** INPUT DATABASES:             ARG_2017_EPHC-S1_v02_M_v05_A_SEDLAC-03_ALL.dta
**                              ARG_2017_EPHC-S1_v02_M_v05_A_SEDLAC-03_GMD.dta
...
datalibweb, country(ARG) year(2017) type(GMD) vermast(02) veralt(05) survey(EPHC) module(ALL) clear
isid hhid pid
...
dlw, coun(`code') y(`year') sur(`survey') t(SEDLAC-03) mod(ALL) verm(02) vera(05)  
