...
** INPUT DATABASES:             ARG_2014_EPHC-S2_v03_M_v01_A_SEDLAC-03_ALL.dta
**                              ARG_2014_EPHC-S2_v03_M_v01_A_SEDLAC-03_GMD.dta
** RESPONSIBLE:                 Leopoldo Tornarolli
** CREATED:                     01/04/2020
** NUMBER OF HOUSEHOLDS:         37,877
** NUMBER OF INDIVIDUALS:       122,477
**                                                                                                 
******************************************************************************************************
******************************************************************************************************/
...
gl baseo "S:\1- RAW DATA\LAC\Argentina\2014\Data"
cd       "S:\2- HARMONIZED DATA\Do and Ini Files for ADePT\LAC\Argentina\2014\2- Do, ini and dta files - Program Specific"
...
datalibweb, country(ARG) year(2014) type(GMD) vermast(03) veralt(01) survey(EPHC) module(ALL) clear
isid hhid pid
...
dlw, coun(`code') y(`year') sur(`survey') t(SEDLAC-03) mod(ALL) verm(03) vera(01)  
...
/* From 06/2014 to 05/2015
   AUH/Embarazo:
      $  644 (General)
   Hijo con Discapacidad: 
      $ 2100 (General) 									*/
gen       sp_mi_auh = 0
replace   sp_mi_auh = v5_m_hd              if  v5_m_hd>=500 & v5_m_hd<=3500
