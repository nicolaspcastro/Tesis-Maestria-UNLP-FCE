...
** INPUT DATABASES:             ARG_2014_EPHC-S2_v03_M_v05_A_SEDLAC-03_ALL.dta
**                              ARG_2014_EPHC-S2_v03_M_v05_A_SEDLAC-03_GMD.dta
...
datalibweb, country(ARG) year(2014) type(GMD) vermast(03) veralt(05) survey(EPHC) module(ALL) clear
isid hhid pid
...
dlw, coun(`code') y(`year') sur(`survey') t(SEDLAC-03) mod(ALL) verm(03) vera(05)  
