...
local year     "1991"  // Year of the survey
...
keep  cod aglomerado tipoviv habita bano agua tenencia material pob_tot 
sort  cod aglomerado
...
sort  cod aglomerado
merge cod aglomerado using "borrar.dta"
tab  _merge
drop _merge
drop if (com==. & edad==.)
