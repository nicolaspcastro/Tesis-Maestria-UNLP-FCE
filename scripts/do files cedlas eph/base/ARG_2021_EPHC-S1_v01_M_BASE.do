...
local year     	"2021"  	// Year of the survey
...
Crea base de Argentina 2021 (EPHC - Semestre I)
...
*******************************************************************************
use          "Trimestre_1"
append using "Trimestre_2.dta", force
duplicates report
duplicates drop

summ   ch04 [w=pondih]		if  trimestre==1
scalar p_trimestre_a = r(sum_w)

summ   ch04 [w=pondih]		if  trimestre==2
